...
内网IP
xxx.xxx.xxx.97     namenode, datanode, resourcemanager, 
...
产生known_hosts  
```
cat /etc/hosts|awk '{print "ssh -o \"StrictHostKeyChecking no\" " $1  " date; ssh -o \"StrictHostKeyChecking no\" " $2 " date; "}'
```
...
chown -R gpadmin:gpadmin /data02/gpadmin
```
...
func() {
rm -f $dir/${splitsuff}*
split -l 5000000 $dir/${1}.csv $dir/${splitsuff}
