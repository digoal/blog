...
disk /dev/sdb, /dev/sdc, ...... /dev/sdm   80002GB
```
...
3\. 分区，注意对齐  
```
#parted -s /dev/dfa mkpart primary 1MiB 1600GB
#parted -s /dev/dfa mkpart primary 1600GB 3200GB
#parted -s /dev/sdb mkpart primary 1MiB 8002GB
#parted -s /dev/sdc mkpart primary 1MiB 8002GB
```
...
`-sda5         8:5    0 210.5G  0 part /home
sdb            8:16   0   7.3T  0 disk 
`-sdb1         8:17   0   7.3T  0 part 
  `-bcache0  251:0    0   7.3T  0 disk /disk1
sdc            8:32   0   7.3T  0 disk 
`-sdc1         8:33   0   7.3T  0 part 
  `-bcache1  251:1    0   7.3T  0 disk 
sdd            8:48   0   7.3T  0 disk 
`-sdd1         8:49   0   7.3T  0 part 
  `-bcache2  251:2    0   7.3T  0 disk 
sde            8:64   0   7.3T  0 disk 
`-sde1         8:65   0   7.3T  0 part 
  `-bcache3  251:3    0   7.3T  0 disk 
sdf            8:80   0   7.3T  0 disk 
`-sdf1         8:81   0   7.3T  0 part 
  `-bcache4  251:4    0   7.3T  0 disk 
sdg            8:96   0   7.3T  0 disk 
`-sdg1         8:97   0   7.3T  0 part 
  `-bcache5  251:5    0   7.3T  0 disk 
sdh            8:112  0   7.3T  0 disk 
`-sdh1         8:113  0   7.3T  0 part 
  `-bcache6  251:6    0   7.3T  0 disk 
sdi            8:128  0   7.3T  0 disk 
`-sdi1         8:129  0   7.3T  0 part 
  `-bcache7  251:7    0   7.3T  0 disk 
sdj            8:144  0   7.3T  0 disk 
`-sdj1         8:145  0   7.3T  0 part 
  `-bcache8  251:8    0   7.3T  0 disk 
sdk            8:160  0   7.3T  0 disk 
`-sdk1         8:161  0   7.3T  0 part 
  `-bcache9  251:9    0   7.3T  0 disk 
sdl            8:176  0   7.3T  0 disk 
`-sdl1         8:177  0   7.3T  0 part 
  `-bcache10 251:10   0   7.3T  0 disk 
sdm            8:192  0   7.3T  0 disk 
`-sdm1         8:193  0   7.3T  0 part 
  `-bcache11 251:11   0   7.3T  0 disk 
dfa          252:0    0   2.9T  0 disk 
|-dfa1       252:1    0   1.5T  0 part 
| |-bcache0  251:0    0   7.3T  0 disk /disk1
| |-bcache1  251:1    0   7.3T  0 disk 
| |-bcache2  251:2    0   7.3T  0 disk 
| |-bcache3  251:3    0   7.3T  0 disk 
