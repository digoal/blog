...
./configure --prefix=/home/dege.zzz/python3.4 --enable-shared  
...
export PGPORT=1921  
export PGDATA=/disk1/dege.zzz/pgdata/pg_root1921  
export LANG=en_US.utf8  
export PGHOME=/home/dege.zzz/pgsql9.6  
export LD_LIBRARY_PATH=/home/dege.zzz/python3.4/lib:$PGHOME/lib:/lib64:/usr/lib64:/usr/local/lib64:/lib:/usr/lib:/usr/local/lib:$LD_LIBRARY_PATH  
export LD_RUN_PATH=$LD_LIBRARY_PATH  
export DATE=`date +"%Y%m%d%H%M"`  
export PATH=/home/dege.zzz/python3.4/bin:$PGHOME/bin:$PATH:.  
...
ln -s /home/dege.zzz/python3.4/bin/python3.4 /home/dege.zzz/python3.4/bin/python  
```  
...
3\. 除了sr_plan插件，PostgreSQL还有一个PLAN HINT插件，可以强行指定执行计划，减少PLAN的时间，同时也可以避免PLAN不稳定的问题。  
