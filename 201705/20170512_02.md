...
假设有100万高频值，分布在67%的区间，那么XX=149万。  
...
\setrandom id 1 200000000 gaussian 149.0  
select f_obj(:id,:uid);    
```    
...
statement latencies in milliseconds:  
        ...
        0.002261        \setrandom id 1 200000000 gaussian 149.0  
...
pipeline=# select * from cv_obj where id=100000000;  
    id     |                                             who_like                                              | like_cnt   
-----------+---------------------------------------------------------------------------------------------------+----------  
 100000000 | {64972217,32501751,5692927,10361609,94890974,85743259,92180974,64216723,11883075,8629030,6137616} |       11  
(1 row)  
  
pipeline=# select * from cv_obj where id=100000001;  
    id     |                                                                     who_like                                                                      | like_cnt   
-----------+---------------------------------------------------------------------------------------------------------------------------------------------------+----------  
 100000001 | {44332690,33829886,32466683,81672971,17545084,13403308,60164198,99185851,81428781,67730207,29716878,98742872,90136055,56495431,81761215,80915090} |       16  
(1 row)  
  
pipeline=# select * from cv_obj where id=100000002;  
    id     |                                                                who_like                                                                 | like_cnt   
-----------+-----------------------------------------------------------------------------------------------------------------------------------------+----------  
 100000002 | {41916483,89283025,8983135,13932319,25041497,47135630,51604863,57838911,96544198,46103499,32005105,46442046,77885300,83007486,84669607} |       15  
(1 row)  
...
[《生成泊松、高斯、指数、随机分布数据 - pg_bench for PostgreSQL》](.../201506/20150618_01.md)     
