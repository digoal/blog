...
1、[《多字段，任意组合(0建模) - 毫秒级实时圈人 - 最佳实践》](../201706/20170607_02.md)      
    
10、[《海量数据 "写入、共享、存储、计算" 最佳实践》](../201705/20170509_02.md)      
...
15、[《PostgreSQL 证券行业数据库需求分析与应用》](../201704/20170417_01.md)      
    
16、[《奔跑吧，大屏 - 时间+空间 实时四维数据透视》](../201704/20170413_02.md)      
    
17、[《为什么啤酒和纸尿裤最搭 - 用HybridDB/PostgreSQL查询商品营销最佳组合》](../201704/20170410_02.md)      
  
23、[《潘金莲改变了历史吗 - PostgreSQL舆情事件分析应用》](../201703/20170331_02.md)      
  
26、[《数据透视 - 商场(如沃尔玛)选址应用》](../201703/20170307_01.md)    
  
39、[《万亿级营销(圈人)潇洒的迈入毫秒时代 - 万亿user_tags级实时推荐系统数据库设计》](../201612/20161225_01.md)      
  
74、[《PostgreSQL\GPDB 多维数据透视典型案例分享》](../201706/20170625_01.md)    
  
6、[《PostgreSQL 聚合表达式 FILTER , order , within group 用法》](../201705/20170504_04.md)      
  
### 海量实时数据处理  
  
9、[《PostgreSQL schemaless 的实现(类mongodb collection)》](../201705/20170511_01.md)     
...
40、[《金融风控、公安刑侦、社会关系、人脉分析等需求分析与数据库实现 - PostgreSQL图数据库场景应用》](../201612/20161213_01.md)      
    
41、[《一场IT民工 与 人贩子 之间的战争 - 只要人人都献出一点爱》](../201612/20161222_01.md)      
  
### 流式SQL处理  
  
7、[《(流式、lambda、触发器)实时处理大比拼 - 物联网(IoT)\金融,时序处理最佳实践》](../201705/20170518_01.md)      
...
43、[《实时数据交换平台 - BottledWater-pg with confluent》](../201612/20161205_02.md)    
  
75、[《数据保留时间窗口的使用》](../201706/20170612_03.md)    
    
### 物联网  
  
2、[《IoT(物联网)极限写入、消费 最佳实践 - 块级(ctid)扫描》](../201706/20170607_01.md)      
...
69、[《PostgreSQL 物联网黑科技 - 瘦身几百倍的索引(BRIN index)》](../201604/20160414_01.md)      
  
### 社交业务  
  
8、[《PCC大赛 - facebook\微博 like场景 - 数据库设计与性能压测》](../201705/20170512_02.md)      
  
48、[《facebook linkbench 测试PostgreSQL社交关系图谱场景性能》](../201609/20160911_01.md)      
  
### 海量全文检索  
  
54、[《PostgreSQL 文本数据分析实践之 - 相似度分析》](../201608/20160817_01.md)      
  
58、[《PostgreSQL 如何高效解决 按任意字段分词检索的问题 - case 1》](../201607/20160725_05.md)      
...
76、[《数据入库实时转换 - trigger , rule》](../201706/20170619_02.md)      
  
25、[《PostgreSQL 数据rotate用法介绍 - 按时间覆盖历史数据》](../201703/20170321_02.md)      
    
10、[《PostgreSQL 如何实现批量更新、删除、插入》](../201704/20170424_05.md)      
    
11、[《PostgreSQL upsert功能(insert on conflict do)的用法》](../201704/20170424_04.md)      
    
20、[《PostgreSQL 如何实现upsert与新旧数据自动分离》](../201605/20160524_02.md)      
    
### 空间实时数据处理业务  
    
14、[《PostgreSQL 物流轨迹系统数据库需求分析与设计 - 包裹侠实时跟踪与召回》](../201704/20170418_01.md)      
  
18、[《多点最优路径规划 - (商旅问题,拼车,餐饮配送,包裹配送,包裹取件,回程单)》](../201704/20170409_01.md)      
...
70、[《PostgreSQL 百亿地理位置数据 近邻查询性能》](../201601/20160119_01.md)      
...
72、[《空间复合索引加速空间搜索》](../201706/20170620_01.md)    
  
34、[《(AR虚拟现实)红包 技术思考 - GIS与图像识别的完美结合》](../201701/20170113_01.md)      
    
46、[《聊一聊双十一背后的技术 - 物流、动态路径规划》](../201611/20161114_01.md)      
...
[《使用PostgreSQL逻辑订阅实现 multi-master》](../201706/20170624_01.md)    
...
36、[《ApsaraDB的左右互搏(PgSQL+HybridDB+OSS) - 解决OLTP+OLAP混合需求》](../201701/20170101_02.md)      
    
### PG全链路特性案例  
  
37、[《从天津滨海新区大爆炸、危化品监管聊聊 IT人背负的社会责任感》](../201612/20161228_01.md)      
  
38、[《从真假美猴王谈起 - 让套牌车、克隆x 无处遁形的技术手段思考》](../201612/20161227_01.md)      
  
### 倒排索引案例  
  
27、[《PostgreSQL GIN 单列聚集索引 应用》](../201702/20170221_01.md)      
    
28、[《PostgreSQL 聚集存储 与 BRIN索引 - 高并发行为、轨迹类大吞吐数据查询场景解说》](../201702/20170219_01.md)      
    
29、[《宝剑赠英雄 - 任意组合字段等效查询, 探探PostgreSQL多列展开式B树 (GIN)》](../201702/20170205_01.md)      
  
### Greenplum 案例  
  
77、[《Greenplum 最佳实践 - 多维分析的使用(CUBE, ROLLUP, GROUPING SETS in GreenPlum and Oracle)》](../201212/20121218_03.md)      
...
79、[《Greenplum 最佳实践 - 数据分布黄金法则 - 分布列与分区的选择》](../201607/20160719_02.md)      
    
80、[《Greenplum 最佳实践 - 行存与列存的选择以及转换方法》](../201608/20160815_01.md)      
    
81、[《Greenplum 最佳实践 - 估值插件hll的使用(以及hll分式聚合函数优化)》](../201608/20160825_02.md)      
    
82、[《Greenplum 最佳实践 - 什么时候选择bitmap索引》](../201705/20170512_01.md)      
    
83、[《PostgreSQL、Greenplum DML合并操作 最佳实践》](../201702/20170214_01.md)      
  
### 其他案例  
  
68、[《论云数据库编程能力的重要性》](../201605/20160505_01.md)      
  
61、[《为了部落 - 如何通过PostgreSQL基因配对，产生优良下一代》](../201606/20160621_01.md)      
    
44、[《用PostgreSQL描绘人生的高潮、尿点、低谷 - 窗口/帧 or 斜率/导数/曲率/微积分?》](../201612/20161203_01.md)      
    
53、[《PostgreSQL 最佳实践 - 读写分离》](../201608/20160824_03.md)      
    
57、[《固若金汤 - PostgreSQL pgcrypto加密插件》](../201607/20160727_02.md)    
    
59、[《PostgreSQL 数据访问 offset 的质变 case》](../201607/20160715_02.md)      
...
20、[《索引顺序扫描引发的堆扫描IO放大背后的统计学原理与解决办法》](../201404/20140426_01.md)      
...
23、[《自动选择正确索引访问接口(btree,hash,gin,gist,sp-gist,brin,bitmap...)的方法》](../201706/20170617_01.md)      
     
24、[《优化器里的概率学 - 性能抖动原理分析》](../201706/20170614_02.md)    
    
## 概念    
    
2、[《PostgreSQL 如何查找TOP SQL (例如IO消耗最高的SQL)》](../201704/20170424_06.md)      
    
3、[《geohash vs PostGIS》](../201704/20170422_01.md)      
    
4、[《PostgreSQL 转义、UNICODE、与SQL注入》](../201704/20170402_01.md)      
    
7、[《PostgreSQL 10.0 preview 性能增强 - 间接索引(secondary index)》](../201703/20170312_21.md)      
    
8、[《PostgreSQL 10.0 preview 优化器改进 - 不完整索引支持复合排序》](../201703/20170312_10.md)     
    
9、[《PostgreSQL 10.0 preview 功能增强 - 唯一约束+附加字段组合功能索引》](../201703/20170312_23.md)      
    
11、[《PostgreSQL bitmapAnd, bitmapOr, bitmap index scan, bitmap heap scan》](../201702/20170221_02.md)      
...
16、[《深入浅出PostgreSQL B-Tree索引结构》](../201605/20160528_01.md)      
...
31、[《PostgreSQL nestloop/hash/merge join讲解》](../201205/20120521_02.md)      
...
43、[《生成泊松、高斯、指数、随机分布数据 - PostgreSQL 9.5 new feature - pg_bench improve, gaussian (standard normal) & exponential distribution》](../201506/20150618_01.md)      
    
47、[《数据库平滑switchover的要素 - 会话资源漂移》](../201706/20170619_01.md)    
    
48、[《列存优化(shard,大小块,归整,块级索引,bitmap scan) - (大量数据实时读写)任意列搜索》](../201706/20170615_01.md)    
    
49、[《懒人推动社会进步 - 多列聚合, gin与数据分布(选择性)》](../201706/20170612_04.md)    
    
50、[《索引扫描优化之 - GIN数据重组优化(按元素聚合) 想象在玩多阶魔方》](../201706/20170612_05.md)    
    
51、[《从一维编排到多维编排，从平面存储到3D存储 - 数据存储优化之路》](../201706/20170614_01.md)    
    
## 方向    
    
2、[《数据库任督二脉 - 数据与计算的生态融合》](../201705/20170526_01.md)      
...
5、[《数据库选型之 - 大象十八摸 - 致 架构师、开发者》](../201702/20170209_01.md)      
    
6、[《数据库选型思考》](../201702/20170208_03.md)      
    
8、[《PostgreSQL 前世今生》](../201609/20160929_02.md)     
...
14、[《PostgreSQL 如何创建不等于索引》](../201701/20170106_02.md)      
    
15、[《PostgreSQL update returning NEW|OLD column value 在对账|购票|防纂改|原子操作中的妙用》](../201611/20161125_02.md)      
    
16、[《如何防止数据库雪崩》](../201609/20160909_01.md)     
    
21、[《随机记录并发查询与更新(转移、删除)的"无耻"优化方法》](../201501/20150129_01.md)      
    
73、[《PostgreSQL 随机查询优化》](../201102/20110212_01.md)      
    
67、[《论count与offset使用不当的罪名 和 分页的优化》](../201605/20160506_01.md)      
     
45、[《聊一聊双十一背后的技术 - 不一样的秒杀技术, 裸秒》](../201611/20161117_01.md)      
...
30、[《Gitlab从删库到恢复 - 数据库备份\恢复\容灾\HA的靠谱姿势》](../201702/20170201_01.md)      
    
31、[《聊聊between and的坑 和 神奇的解法》](../201701/20170126_02.md)     
...
35、[《想挑战AlphaGO吗？先和PostgreSQL玩一玩?? PostgreSQL与人工智能(AI)》](../201701/20170106_01.md)      
...
47、[《MySQL 增量同步到 PostgreSQL》](../201610/20161020_01.md)      
...
56、[《论数据库redo/data存储规划与SSD写倾斜》](../201607/20160728_02.md)      
...
60、[《找对业务G点, 体验酸爽 - PostgreSQL内核扩展指南》](../201606/20160626_01.md)      
...
[《PostgreSQL 跟踪谁动了你的记录 - Use timetravel function trace tuple's DML》](../201201/20120113_02.md)      
...
[《DBA一族九阳神功秘籍，标准和制度(含重大节日)》](../201701/20170120_02.md)      
...
1、[《从redo日志分析数据库的profile》](../201705/20170504_02.md)      
    
2、[《PostgreSQL 锁等待监控 珍藏级SQL - 谁堵塞了谁》](../201705/20170521_01.md)      
    
3、[《PostgreSQL物理"备库"的哪些操作或配置，可能影响"主库"的性能、垃圾回收、IO波动》](../201704/20170410_03.md)      
    
4、[《PostgreSQL 数据文件灾难恢复 - 解析与数据dump》](../201703/20170310_03.md)      
    
5、[《PostgreSQL 使用pg_xlogdump找到误操作事务号》](../201510/20151210_01.md)      
    
6、[《PostgreSQL 清理redo(xlog,wal,归档)的机制 及 如何手工清理》](../201702/20170216_01.md)      
    
7、[《PostgreSQL 源码性能诊断(perf profiling)指南》](../201611/20161129_01.md)      
    
8、[《Linux 性能诊断 perf使用指南》](../201611/20161127_01.md)      
    
9、[《从PostgreSQL支持100万个连接聊起》](../201608/20160805_01.md)      
    
10、[《DBA不可不知的操作系统内核参数》](../201608/20160803_01.md)      
    
11、[《PostgreSQL on Linux 最佳部署手册》](../201611/20161121_01.md)      
    
12、[《PostgreSQL 函数调试、诊断、优化 & auto_explain》](../201611/20161121_02.md)      
    
13、[《PostgreSQL 收缩膨胀表或索引 - pg_squeeze or pg_repack》](../201610/20161030_02.md)      
    
14、[《使用pg_resetxlog修复PostgreSQL控制文件的方法》](../201608/20160814_02.md)      
    
15、[《异版本pg_resetxlog后导致的控制文件差异问题处理》](../201608/20160814_01.md)      
    
16、[《PostgreSQL 老湿机图解垃圾回收的"坑"》](../201607/20160715_01.md)      
    
17、[《PostgreSQL relcache在长连接应用中的内存霸占"坑"》](../201607/20160709_01.md)      
    
18、[《关键时刻HINT出彩 - PG优化器的参数优化、执行计划固化CASE》](../201607/20160723_02.md)      
    
19、[《PostgreSQL的"天气预报" - 如何预测Freeze IO风暴》](../201606/20160612_01.md)      
    
20、[《索引顺序扫描引发的堆扫描IO放大背后的统计学原理与解决办法 - PostgreSQL index scan enlarge heap page scans when index and column correlation small.》](../201404/20140426_01.md)      
...
## 概念    
1、[《异步流复制模式如何保证不丢数据?》](../201705/20170504_03.md)      
...
5、[《PostgreSQL 9.6 内核优化之 聚合代码优化OP复用浅析》](../201610/20161008_01.md)      
    
6、[《聊一下PostgreSQL优化器 - in里面有重复值时PostgreSQL如何处理?》](../201612/20161223_01.md)      
...
10、[《PostgreSQL 10.0 preview 主动防御 - 可配置是否允许执行不带where条件的update\delete》](../201703/20170312_01.md)      
...
13、[《PostgreSQL 10.0 preview 安全增强 - SASL认证方法 之 scram-sha-256 安全认证机制》](../201703/20170309_01.md)      
...
18、[《PostgreSQL standby recover的源码分析 (walreceiver唤醒时机？ 为什么standby crash后walreceiver不会立即被唤醒?)》](../201612/20161229_01.md)      
...
20、[《PostgreSQL views privilege attack and security with security_barrier(视图攻击)》](../201307/20130710_01.md)      
    
21、[《PostgreSQL 如何精确计算表膨胀(fsm,数据块layout讲解) - PostgreSQL table exactly bloat monitor use freespace map data》](../201306/20130628_01.md)      
...
33、[《PostgreSQL 优化器逻辑推理能力 源码解析》](../201602/20160225_01.md)      
    
34、[《PostgreSQL 操作符与优化器详解》](../201602/20160224_01.md)      
    
35、[《PostgreSQL 9.6 黑科技 bloom 算法索引，一个索引支撑任意列组合查询》](../201605/20160523_01.md)      
    
36、[《PostgreSQL 大表自动 freeze 优化思路》](../201605/20160520_01.md)     
    
37、[《PostgreSQL 逻辑结构 和 权限体系 介绍》](../201605/20160510_01.md)      
...
45、[《PostgreSQL SSL链路压缩例子》](../201508/20150818_01.md)      
    
46、[《PostgreSQL 回收站功能 - 基于HOOK的recycle bin pgtrashcan》](../201404/20140403_01.md)      
...
1、[《AI(OtterTune)引波澜 - AI会洗牌数据库行业吗? DBA如何转变思想》](../201706/20170605_01.md)      
...
7、[《小鸡吉吉小猪佩吉小象Pi吉(PostgreSQL) 祝大家吉祥如意，幸福安康，阖家欢乐!》](../201701/20170120_01.md)      
    
8、[《PostgreSQL 前世今生》](../201609/20160929_02.md)     
    
## 开发技巧    
    
1、[《PostgreSQL UDF实现IF NOT EXISTS语法》](../201706/20170605_02.md)      
    
2、[《采用 部分索引、表达式索引 提高搜索效率》](../201706/20170603_01.md)      
    
3、[《PostgreSQL 表达式索引 - 语法注意事项》](../201608/20160803_02.md)      
...
7、[《如何优雅的修改被视图引用的表字段》](../201705/20170503_01.md)      
    
8、字符本土化    
    
[《如何按拼音排序 - 数据库本土化特性(collate, ctype, ...)》](../201704/20170424_03.md)      
    
[《PostgreSQL全角、半角互相转换》](../201705/20170504_01.md)      
    
[《在PostgreSQL中实现按拼音、汉字、拼音首字母搜索的例子》](../201611/20161109_01.md)      
    
[《如何判断字符串是否为合法数值、浮点、科学计数等格式》](../201704/20170412_03.md)      
    
[《PostgreSQL 中如何找出记录中是否包含编码范围内的字符，例如是否包含中文》](../201703/20170310_02.md)      
    
9、[《PostgreSQL 数组忽略大小写匹配》](../201611/20161119_01.md)      
    
10、[《PostgreSQL 如何实现批量更新、删除、插入》](../201704/20170424_05.md)      
    
11、[《PostgreSQL upsert功能(insert on conflict do)的用法》](../201704/20170424_04.md)      
    
12、[《PostgreSQL 中生成随机汉字》](../201704/20170425_01.md)      
    
13、[《如何在PostgreSQL中调试plpgsql存储过程(pldebugger, pldbgapi)》](../201704/20170424_02.md)      
    
14、[《PostgreSQL != , <> 索引》](../201701/20170106_02.md)      
    
15、[《PostgreSQL update returning NEW|OLD column value 在对账|购票|防纂改|原子操作中的妙用》](../201611/20161125_02.md)      
    
16、[《如何防止数据库雪崩》](../201609/20160909_01.md)     
    
17、[《在PostgreSQL中实现update | delete limit》](../201608/20160827_01.md)      
    
18、[《PostgreSQL Oracle 兼容性之 - connect by》](../201606/20160614_03.md)      
    
19、[《PostgreSQL 事务，会话 GUC 变量 妙用 - 获取并跟踪事务结束时间(不是来自XLOG commit record哦)》](../201601/20160106_03.md)      
    
20、[《PostgreSQL 如何实现upsert与新旧数据自动分离》](../201605/20160524_02.md)      
    
21、[《随机记录并发查询与更新(转移、删除)的"无耻"优化方法》](../201501/20150129_01.md)      
    
22、[《PostgreSQL 大行优化, large row|column performance tuning case》](../201301/20130109_01.md)      
    
23、[《行列变换 - Use tablefunc complete row & column cross display in PostgreSQL》](../201106/20110612_01.md)      
    
24、[《PostgreSQL : WITH Queries use case》](../201104/20110427_01.md)      
