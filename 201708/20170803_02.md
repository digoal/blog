...
```    
select row_number() over (partition by domain||key order by domain,key) as RN, domain||key, data from  
...
执行计划
                                                               ...
                                                               QUERY PLAN                                                                
-----------------------------------------------------------------------------------------------------------------------------------------
 Insert (slice0; segments: 3)  (rows=333334 width=72)
   ->  Subquery Scan "*SELECT*"  (cost=375072.68..395072.68 rows=333334 width=72)
         ->  Window  (cost=375072.68..385072.68 rows=333334 width=96)
               Partition By: "?column?"
               Order By: t.key
               ->  Sort  (cost=375072.68..377572.68 rows=333334 width=96)
                     Sort Key: "?column?", t.key
...
```    
select row_number() over (partition by tid||key order by key) as RN, tid||key, data from  
(  
  select   
    t1.tid,   
...
postgres=# select * from t1_output  limit 100;  
  rn  |  fmt   |                        data                        
------+--------+----------------------------------------------------
    3 | 90000  | tid: 9 , c2: test , c4: 2017-08-16 15:36:27.531807
   19 | 90000  | tid: 9 , c2: test , c4: 2017-08-16 15:36:27.534504
  131 | 90000  | tid: 9 , c2: test , c4: 2017-08-16 15:36:27.554004
  163 | 90000  | tid: 9 , c2: test , c4: 2017-08-16 15:36:27.560309
  179 | 90000  | tid: 9 , c2: test , c4: 2017-08-16 15:36:27.56432
  211 | 90000  | tid: 9 , c2: test , c4: 2017-08-16 15:36:27.569437
  264 | 90000  | tid: 9 , c2: test , c4: 2017-08-16 15:36:27.578347
  280 | 90000  | tid: 9 , c2: test , c4: 2017-08-16 15:36:27.580974
  392 | 90000  | tid: 9 , c2: test , c4: 2017-08-16 15:36:27.599048
  424 | 90000  | tid: 9 , c2: test , c4: 2017-08-16 15:36:27.603584
  440 | 90000  | tid: 9 , c2: test , c4: 2017-08-16 15:36:27.606073
  472 | 90000  | tid: 9 , c2: test , c4: 2017-08-16 15:36:27.61265
.....
写OSS外部表时，第一列和第二列不会输出。
```  
