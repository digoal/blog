...
排查业务逻辑错误、资源限制错误、数据库内核层面的严重错误。  
  
对于业务逻辑错误，建议在QUERY时过滤，避免日志过多。  
...
gp_toolkit.gp_log_command_timings                  gp_toolkit.gp_resq_priority_backend                gp_toolkit.gp_size_of_table_disk                   gp_toolkit.gp_workfile_usage_per_segment  
gp_toolkit.gp_log_database                         gp_toolkit.gp_resq_priority_statement              gp_toolkit.gp_size_of_table_uncompressed             
gp_toolkit.gp_log_master_concise                   gp_toolkit.gp_resq_role                            gp_toolkit.gp_skew_coefficients                      
gp_toolkit.__gp_log_master_ext                     gp_toolkit.gp_resqueue_status   
