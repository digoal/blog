...
如果我们有一个系统，收集了所以对象的供需能力，利用这个系统可以作为供需双方的桥梁（也可能是供需多方）与生产平衡，尽可能的减少产能过剩。     
  
众包、众筹平台、证券交易平台都是类似的系统。      
  
研究供需、生态链、利益链是很有趣的事情。如果你做的事情是很多人都需要的，或者你在做的是供不应求的事情，显然会很受欢迎。就比如今天的PG人才就是供不应求的。       
