...
#### 2. 改进Orange，支持kibana所有可视化分析功能(图、地理、。。。。)      
      
https://orange.biolab.si/        
      
#### 3. 改进kibana，兼容postgresql      
...
#### 46. postgresql, 支持flashback, 例如postgresql 主备切换时，老的主库在没有配置recovery.conf时启动并有写入，导致分裂。使用flashback可以快速回到上一个时间线。      
