...
duration: 300 s  
number of transactions actually processed: 198799269  
latency average = 0.169 ms  
latency stddev = 0.324 ms  
tps = 662553.482684 (including connections establishing)  
tps = 662587.380857 (excluding connections establishing)  
script statistics:  
 - statement latencies in milliseconds:  
         0.002  \set id random(1,100000000)  
         0.171  select * from test where id=:id;  
```  
