...
duration: 300 s  
number of transactions actually processed: 1442422  
latency average = 5.330 ms  
latency stddev = 17.754 ms  
tps = 9823.053734 (including connections establishing)  
tps = 9824.819392 (excluding connections establishing)  
script statistics:  
 - statement latencies in milliseconds:  
         0.002  \set sid random(1,1024)    
         5.328  select ins_sensor(:sid, 1000);  
```      
