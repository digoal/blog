...
duration: 300 s  
number of transactions actually processed: 1238374  
latency average = 6.049 ms  
latency stddev = 6.632 ms  
tps = 8480.021798 (including connections establishing)  
tps = 8481.798726 (excluding connections establishing)  
script statistics:  
 - statement latencies in milliseconds:  
         0.002  \set sid random(1,1024)    
         6.048  select ins_sensor(:sid, 1000);  
```        
