...
```
pg_trgm   DATABASE的Collation  Ctype不能为C，如果已经是这样，可以新建一个DB，改掉它。   create database db with template template0 encoding 'UTF8' LC_COLLATE 'en_US.UTF8' LC_CTYPE 'en_US.UTF8';
