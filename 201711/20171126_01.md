...
insert into tag_log values (md5(:imei::text), 'insert', (array[:tag1,:tag2,:tag3,:tag4,:tag5,:tag6,:tag7,:tag8])::int[]);  
...
\set mov random(0,15)  
select consume_tag_log(16,:mov,10000) where pg_try_advisory_xact_lock(:mov);  
