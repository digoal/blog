...
create index idx_tbl_1 on tbl using btree (sid, hid, ts);  
create index idx_tbl_5min_1 on tbl_5min using btree (sid, hid, ts);  
create index idx_tbl_30min_1 on tbl_30min using btree (sid, hid, ts);  
```  
