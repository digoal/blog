## Oracle DBA 转型 PostgreSQL,Greenplum 学习计划  
...
采用阿里云提供的[ADAM](https://promotion.aliyun.com/ntms/act/ppasadam.html)，甚至可以做到精确的衡量 (报告会明确告诉：有多少对象，有多少兼容，多少不兼容，不兼容的如何修改等) 。      
...
热烈期待Oracle专业DBA加入，有OCM证书，有丰富的开发DBA与管理DBA经验，越年轻越好(当然也期待有一颗年轻的心，体力无限的大叔)，有上进心，喜爱学习，喜爱用技术解决业务的问题。   
