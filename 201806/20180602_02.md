...
## 背景     
HeteroDB pg_strom是PG的一个GPU加速插件，目前已支持到10的版本。  
...
GPU的引入，无疑又拔高了数据库的分析能力。本文使用民用硬件对pg_strom进行了一系列测试，生产中的硬件要被测试好很多很多，GPU的加速会更加的明显。    
  
![pic](20180602_02_pic_005.jpg)    
  
![pic](20180602_02_pic_006.jpg)    
    
目前heteroDB稳定性还有打磨的空间。  
