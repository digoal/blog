...
```  
create or replace function gp_upsert(nsp name, tbl name, keys text[], ik text[], icontent jsonb) returns void as $$  -- icontent中也必须包含PK的内容。  
declare  
  k text;  
  v text;  
...
DELETE 1
postgres=# select gp_upsert('public', 'test', array['id1','id2'], array['1','2'], '{"id1":1, "id2":2, "info":"digoal  ab", "c1":123, "c2":1.1, "c3":1.9999, "crt_time":"2018-01-01 10:10:10"}'::jsonb);
 gp_upsert 
-------------
...
postgres=# select gp_upsert('public', 'test', array['id1','id2'], array['1','2'], '{"id1":1, "id2":2, "info":"digoal  ab", "c1":123, "c3":2.9999, "crt_time":null}'::jsonb);
 gp_upsert 
-------------
...
postgres=# select gp_upsert('public', 'test', array['id1','id2'], array['1','1'], '{"id1":1, "id2":1, "info":"digoal  ab", "c1":123, "c3":2.9999, "crt_time":null}'::jsonb);
 gp_upsert 
-------------
...
select gp_upsert('public', 'test', array['id1','id2'], array[':id1',':id2'], '{"id1": :id1, "id2": :id2, :a}'::jsonb);
```
...
script statistics:
 - statement latencies in milliseconds:
         ...
         2.721  select gp_upsert('public', 'test', array['id1','id2'], array[':id1',':id2'], '{"id1": :id1, "id2": :id2, :a}'::jsonb);
```
...
```  
create or replace function gp_upsert(nsp name, tbl name, keys text[], ik text[], icontent json) returns void as $$  -- icontent中也必须包含PK的内容。  
declare  
  k text;  
  v text;  
  sql1 text := 'update '||quote_ident(nsp)||'.'||quote_ident(tbl)||' set ';  
...
postgres=> delete from test;
DELETE 1
postgres=> select gp_upsert('public', 'test', array['id1','id2'], array['1','2'], '{"id1":1, "id2":2, "info":"digoal  ab", "c1":123, "c2":1.1, "c3":1.9999, "crt_time":"2018-01-01 10:10:10"}'::json);
 gp_upsert 
-------------
...
postgres=> select gp_upsert('public', 'test', array['id1','id2'], array['1','2'], '{"id1":1, "id2":2, "info":"digoal  ab", "c1":123, "c3":2.9999, "crt_time":null}'::json);
 gp_upsert 
-------------
...
postgres=> select gp_upsert('public', 'test', array['id1','id2'], array['1','1'], '{"id1":1, "id2":1, "info":"digoal  ab", "c1":123, "c3":2.9999, "crt_time":null}'::json);
 gp_upsert 
-------------
...
\set id1 random(1,1000)
\set id2 random(1,10000)
select gp_upsert('public', 'test', array['id1','id2'], array[':id1',':id2'], '{"id1": :id1, "id2": :id2, :a}'::json);
