...
postgres=> select upsert_test('test', array['id1','id2'], array['1','2'], '{"id1":1, "id2":2, "info":"digoal  ab", "c1":123, "c2":1.1, "c3":null, "crt_time":null}'::json); 
 upsert_test 
-------------
...
-----+-----+------------+-----+-----+----+----+----------
   1 |   2 | digoal  ab | 123 | 1.1 |    |    | 
(1 row)

postgres=> select upsert_test('test', array['id1','id2'], array['1','2'], '{"id1":1, "id2":2, "info":"digoal  ab", "c1":123, "c2":1.1, "c3":9.2310, "crt_time":null}'::json); 
 upsert_test 
-------------
...
postgres=> select * from test;
 id1 | id2 |    info    | c1  | c2  |         c3         | c4 | crt_time 
-----+-----+------------+-----+-----+--------------------+----+----------
   1 |   2 | digoal  ab | 123 | 1.1 | 9.2309999999999999 |    | 
(1 row)

postgres=> select upsert_test('test', array['id1','id2'], array['1','2'], E'{"id1":1, "id2":2, "info":"digoal \' ab", "c1":123, "c2":1.1, "c3":9.2310, "crt_time":null}'::json); 
 upsert_test 
-------------
...
postgres=> select upsert_test('test', array['id1','id2'], array['1','2'], E'{"id1":1, "id2":2, "info":"digoal \' ab", "c1":123456}'::json); 
 upsert_test 
-------------
...
postgres=> select * from test;
 id1 | id2 |    info     |   c1   | c2  |         c3         | c4 | crt_time 
-----+-----+-------------+--------+-----+--------------------+----+----------
   1 |   2 | digoal ' ab | 123456 | 1.1 | 9.2309999999999999 |    | 
(1 row)
