## PostgreSQL 设计优化case - 大宽表任意字段组合查询索引如何选择(btree, gin, rum)  
...
---|---|---|---|---|---|---  
128列单个gin(fastupdate=on)索引 | 3.99万行/s | 最大 | 不好(pending tuples很大时) | 不好(pending tuples很大时) | 不好(pending tuples很大时) | 不好(pending tuples很大时)   
128列单个gin(fastupdate=off)索引 | 1.36万行/s | 最大 | 好 | 不好 | 好 | 一般  
128列单个rum索引 | 0.378万行/s | 较小 | 很好 | 不好 | 一般 | 好  
128列128个btree索引 | 1.59万行/s | 较小 | 很好 | 不好 | 一般 | 好  
