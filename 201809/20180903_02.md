...
```
postgres=# select source,name,setting,unit from pg_settings where source<>'default' or name ~ '^gp_' order by source,category,name;
        source        |                    name                     |                                     setting                                      | unit 
----------------------+---------------------------------------------+----------------------------------------------------------------------------------+------
 client               | application_name                            | psql                                                                             | 
 command line         | TimeZone                                    | PRC                                                                              | 
 command line         | timezone_abbreviations                      | Default                                                                          | 
 command line         | listen_addresses                            | *                                                                                | 
 command line         | port                                        | 15432                                                                            | 
 command line         | gp_contentid                                | -1                                                                               | 
 command line         | gp_dbid                                     | 1                                                                                | 
 command line         | gp_num_contents_in_cluster                  | 144                                                                              | 
 command line         | gp_standby_dbid                             | 0                                                                                | 
 command line         | log_timezone                                | PRC                                                                              | 
 configuration file   | max_appendonly_tables                       | 10000                                                                            | 
 configuration file   | DateStyle                                   | ISO, MDY                                                                         | 
 configuration file   | default_text_search_config                  | pg_catalog.english                                                               | 
 configuration file   | lc_messages                                 | en_US.utf8                                                                       | 
 configuration file   | lc_monetary                                 | en_US.utf8                                                                       | 
 configuration file   | lc_numeric                                  | en_US.utf8                                                                       | 
 configuration file   | lc_time                                     | en_US.utf8                                                                       | 
 configuration file   | max_connections                             | 25                                                                               | 
 configuration file   | gp_autostats_mode                           | ON_NO_STATS                                                                      | 
 configuration file   | gp_autostats_on_change_threshold            | 2147483647                                                                       | 
 configuration file   | gp_backup_directIO                          | off                                                                              | 
 configuration file   | gp_backup_directIO_read_chunk_mb            | 20                                                                               | 
 configuration file   | gp_connections_per_thread                   | 0                                                                                | 
 configuration file   | gp_interconnect_type                        | UDPIFC                                                                           | 
 configuration file   | gp_segment_connect_timeout                  | 600                                                                              | s
 configuration file   | gp_xliw_agent_enable                        | off                                                                              | 
 configuration file   | gp_xliw_log_level                           | 8                                                                                | 
 configuration file   | gp_xliw_unix_path                           | /tmp/xliwagent.socket                                                            | 
 configuration file   | gp_xliw_worker_num                          | 2                                                                                | 
 configuration file   | log_autostats                               | off                                                                              | 
 configuration file   | log_statement                               | all                                                                              | 
 configuration file   | max_prepared_transactions                   | 250                                                                              | 
 configuration file   | max_fsm_pages                               | 200000                                                                           | 
 configuration file   | gp_vmem_protect_limit                       | 8192                                                                             | 
 configuration file   | shared_buffers                              | 4000                                                                             | 32kB
 configuration file   | gp_resqueue_memory_policy                   | eager_free                                                                       | 
 configuration file   | optimizer_analyze_root_partition            | on                                                                               | 
 default              | gp_appendonly_compaction_threshold          | 10                                                                               | 
 default              | gp_default_storage_options                  | appendonly=false,blocksize=32768,compresstype=none,checksum=true,orientation=row | 
 default              | gp_command_count                            | 41                                                                               | 
 default              | gp_connection_send_timeout                  | 3600                                                                             | 
 default              | gp_role                                     | dispatch                                                                         | 
 default              | gp_session_id                               | 504                                                                              | 
 default              | gp_vmem_idle_resource_timeout               | 18000                                                                            | ms
 default              | gp_hadoop_home                              |                                                                                  | 
 default              | gp_hadoop_target_version                    | hadoop                                                                           | 
 default              | gp_autostats_mode_in_functions              | NONE                                                                             | 
 default              | gp_debug_linger                             | 0                                                                                | s
 default              | gp_reraise_signal                           | on                                                                               | 
 default              | gp_workfile_compress_algorithm              | none                                                                             | 
 default              | gp_external_enable_exec                     | on                                                                               | 
 default              | gp_external_enable_filter_pushdown          | off                                                                              | 
 default              | gp_external_max_segs                        | 64                                                                               | 
 default              | gp_initial_bad_row_limit                    | 1000                                                                             | 
 default              | gp_max_csv_line_length                      | 1048576                                                                          | 
 default              | gp_reject_percent_threshold                 | 300                                                                              | 
 default              | gp_cached_segworkers_threshold              | 5                                                                                | 
 default              | gp_filerep_ct_batch_size                    | 65536                                                                            | 
 default              | gp_filerep_tcp_keepalives_count             | 2                                                                                | 
 default              | gp_filerep_tcp_keepalives_idle              | 60                                                                               | s
 default              | gp_filerep_tcp_keepalives_interval          | 30                                                                               | s
 default              | gp_fts_probe_interval                       | 60                                                                               | s
 default              | gp_fts_probe_threadcount                    | 16                                                                               | 
 default              | gp_fts_probe_timeout                        | 20                                                                               | s
 default              | gp_hashjoin_tuples_per_bucket               | 5                                                                                | 
 default              | gp_interconnect_cache_future_packets        | on                                                                               | 
 default              | gp_interconnect_debug_retry_interval        | 10                                                                               | 
 default              | gp_interconnect_deepmesh_path               | /tmp/dmagent.socket                                                              | 
 default              | gp_interconnect_default_rtt                 | 20                                                                               | ms
 default              | gp_interconnect_fc_method                   | LOSS                                                                             | 
 default              | gp_interconnect_hash_multiplier             | 2                                                                                | 
 default              | gp_interconnect_min_retries_before_timeout  | 100                                                                              | 
 default              | gp_interconnect_min_rto                     | 20                                                                               | ms
 default              | gp_interconnect_queue_depth                 | 4                                                                                | 
 default              | gp_interconnect_setup_timeout               | 7200                                                                             | s
 default              | gp_interconnect_snd_queue_depth             | 2                                                                                | 
 default              | gp_interconnect_tcp_listener_backlog        | 128                                                                              | 
 default              | gp_interconnect_timer_checking_period       | 20                                                                               | ms
 default              | gp_interconnect_timer_period                | 5                                                                                | ms
 default              | gp_interconnect_transmit_timeout            | 3600                                                                             | s
 default              | gp_max_packet_size                          | 8192                                                                             | 
 default              | gp_udp_bufsize_k                            | 0                                                                                | 
 default              | gp_master_addr                              | 127.0.0.1                                                                        | 
 default              | gp_max_partition_level                      | 0                                                                                | 
 default              | gp_max_slices                               | 0                                                                                | 
 default              | gp_server_version                           | 5.10.2+7615c3b build ga                                                          | 
 default              | gp_server_version_num                       | 51002                                                                            | 
 default              | gp_enable_fast_sri                          | on                                                                               | 
 default              | gp_enable_predicate_propagation             | on                                                                               | 
 default              | gp_workfile_checksumming                    | on                                                                               | 
 default              | gp_motion_cost_per_row                      | 0                                                                                | 
 default              | gp_segments_for_planner                     | 0                                                                                | 
 default              | gp_adjust_selectivity_for_outerjoins        | on                                                                               | 
 default              | gp_dynamic_partition_pruning                | on                                                                               | 
 default              | gp_enable_agg_distinct                      | on                                                                               | 
 default              | gp_enable_agg_distinct_pruning              | on                                                                               | 
 default              | gp_enable_direct_dispatch                   | on                                                                               | 
 default              | gp_enable_fallback_plan                     | on                                                                               | 
 default              | gp_enable_groupext_distinct_gather          | on                                                                               | 
 default              | gp_enable_groupext_distinct_pruning         | on                                                                               | 
 default              | gp_enable_multiphase_agg                    | on                                                                               | 
 default              | gp_enable_preunique                         | on                                                                               | 
 default              | gp_enable_relsize_collection                | off                                                                              | 
 default              | gp_enable_sequential_window_plans           | on                                                                               | 
 default              | gp_enable_sort_distinct                     | on                                                                               | 
 default              | gp_enable_sort_limit                        | on                                                                               | 
 default              | gp_idf_deduplicate                          | auto                                                                             | 
 default              | gp_statistics_pullup_from_child_partition   | on                                                                               | 
 default              | gp_statistics_use_fkeys                     | on                                                                               | 
 default              | gp_email_connect_avoid_duration             | 7200                                                                             | 
 default              | gp_email_connect_failures                   | 5                                                                                | 
 default              | gp_email_connect_timeout                    | 15                                                                               | 
 default              | gp_email_from                               |                                                                                  | 
 default              | gp_email_smtp_password                      |                                                                                  | 
 default              | gp_email_smtp_server                        | localhost:25                                                                     | 
 default              | gp_email_smtp_userid                        |                                                                                  | 
 default              | gp_email_to                                 |                                                                                  | 
 default              | gp_snmp_community                           | public                                                                           | 
 default              | gp_snmp_monitor_address                     |                                                                                  | 
 default              | gp_snmp_use_inform_or_trap                  | trap                                                                             | 
 default              | gp_gpperfmon_send_interval                  | 1                                                                                | 
 default              | gp_log_format                               | csv                                                                              | 
 default              | gp_resource_group_bypass                    | off                                                                              | 
 default              | gp_resource_group_cpu_limit                 | 0.9                                                                              | 
 default              | gp_resource_group_cpu_priority              | 10                                                                               | 
 default              | gp_resource_group_memory_limit              | 0.7                                                                              | 
 default              | gp_resource_manager                         | queue                                                                            | 
 default              | gp_safefswritesize                          | 0                                                                                | 
 default              | gp_subtrans_warn_limit                      | 16777216                                                                         | 
 default              | gp_workfile_limit_files_per_query           | 100000                                                                           | 
 default              | gp_workfile_limit_per_query                 | 0                                                                                | 
 default              | gp_workfile_limit_per_segment               | 0                                                                                | 
 default              | gp_set_proc_affinity                        | off                                                                              | 
 default              | gp_max_databases                            | 16                                                                               | 
 default              | gp_max_filespaces                           | 8                                                                                | 
 default              | gp_max_local_distributed_cache              | 1024                                                                             | 
 default              | gp_max_plan_size                            | 0                                                                                | kB
 default              | gp_max_tablespaces                          | 16                                                                               | 
 default              | gp_vmem_protect_segworker_cache_limit       | 500                                                                              | 
 default              | gp_resgroup_memory_policy                   | eager_free                                                                       | 
 default              | gp_resqueue_priority                        | off                                                                              | 
 default              | gp_resqueue_priority_cpucores_per_segment   | 4                                                                                | 
 default              | gp_resqueue_priority_sweeper_interval       | 1000                                                                             | 
 default              | gp_analyze_relative_error                   | 0.25                                                                             | 
 default              | gp_enable_gpperfmon                         | off                                                                              | 
 default              | gp_enable_query_metrics                     | off                                                                              | 
 default              | gp_instrument_shmem_size                    | 5120                                                                             | kB
 default              | gp_create_table_random_default_distribution | off                                                                              | 
 default              | gp_enable_exchange_default_partition        | off                                                                              | 
 environment variable | max_stack_depth                             | 2048                                                                             | kB
 override             | lc_collate                                  | en_US.utf8                                                                       | 
 override             | lc_ctype                                    | en_US.utf8                                                                       | 
 override             | server_encoding                             | UTF8                                                                             | 
 override             | transaction_isolation                       | read committed                                                                   | 
 override             | transaction_read_only                       | off                                                                              | 
