## [未完待续]PostgreSQL 11 TPCC , TPCB 7*24 强压耐久测试    
...
运行至105235秒（约29小时）时，数据库的大小已达到1.9TB。  
...
### 结果  
7*24小时压测，数据库完成了5xx亿个事务，50几次freeze，性能平稳。    
   
## 小结
### 1、1000万 tpcc测试，在16小时压测后，约1.8W tps，108 万tpmC。  
  
由于TPCC不断有数据写入，29小时后，活跃数据量已接近2TB，IO等待已成为瓶颈，TPS下降到1.3万左右。   
