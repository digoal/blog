## PostgreSQL , EDB EPAS PPAS(兼容Oracle) , Oracle 对比（兼容性、特性优劣势）
...
Oracle 内置 package | 26种，260个func | 13种，通过orafce支持兼容。(实际使用体验较弱，因为通常package会结合plsql使用)    
...
多模-JSON | 支持 | 支持 (带索引加速)    
多模-全文检索 | 不支持 | 支持(分词、索引、自定义分词、rank等 带索引加速)    
