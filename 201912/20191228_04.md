...
---|---|---|---|---    
fdatasync 8K | 28216 | 6087 | 5901 | 6221    
    
### fio测试（iops能力，吞吐能力）    
    
test case | 本地ssd 1.8T\*8 | essd pl3 1.8T\*8 | (26核)essd pl3 20T | (52核)essd pl3 20T 
---|---|---|---|---   
8k 随机写 | IOPS=131k, BW=1024MiB/s | IOPS=106k, BW=825MiB/s | IOPS=106k, BW=826MiB/s | IOPS=167k, BW=1303MiB/s   
8k 随机读 | IOPS=153k, BW=1193MiB/s | IOPS=106k, BW=826MiB/s | IOPS=106k, BW=830MiB/s | IOPS=141k, BW=1103MiB/s   
8k 顺序写 | IOPS=134k, BW=1050MiB/s | IOPS=106k, BW=826MiB/s | IOPS=106k, BW=824MiB/s | IOPS=158k, BW=1231MiB/s   
8k 顺序读 | IOPS=151k, BW=1182MiB/s | IOPS=106k, BW=829MiB/s | IOPS=106k, BW=825MiB/s | IOPS=121k, BW=943MiB/s     
...
test case | 本地ssd 1.8T\*8 | essd pl3 1.8T\*8 | (26核)essd pl3 20T | (52核)essd pl3 20T    
---|---|---|---|---    
10亿写入 | 1058秒 | 948秒 | 1082秒 | 1058秒      
10亿只读 | qps: 627000（服务器512G内存，全内存命中） | qps: 64979 （服务器192G内存，命中低，同时io rt不如本地盘）| qps: 37253 （服务器192G内存，命中低，同时io rt不如本地盘）| qps: 887505  （服务器384G内存，全内存命中）   
10亿读写 | tps  31545 , qps  157725 | tps 25595 ，qps 127975 | tps 28627 , qps 143135 | tps  78006 , qps  390030      
