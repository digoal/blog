...
test case | 本地ssd 1.8T\*8 | essd pl3 1.8T\*8 | essd pl3 20T  
---|---|---|---  
fdatasync 8K | 28216 | 6087 | 5901  
  
### fio测试（iops能力，吞吐能力）  
  
test case | 本地ssd 1.8T\*8 | essd pl3 1.8T\*8 | essd pl3 20T  
---|---|---|---  
8k 随机写 | IOPS=131k, BW=1024MiB/s | IOPS=106k, BW=825MiB/s | IOPS=106k, BW=826MiB/s  
8k 随机读 | IOPS=153k, BW=1193MiB/s | IOPS=106k, BW=826MiB/s | IOPS=106k, BW=830MiB/s  
8k 顺序写 | IOPS=134k, BW=1050MiB/s | IOPS=106k, BW=826MiB/s | IOPS=106k, BW=824MiB/s  
8k 顺序读 | IOPS=151k, BW=1182MiB/s | IOPS=106k, BW=829MiB/s | IOPS=106k, BW=825MiB/s  
...
test case | 本地ssd 1.8T\*8 | essd pl3 1.8T\*8 | essd pl3 20T  
---|---|---|---  
10亿写入 | 1058秒 | 948秒 | 1082秒  
10亿只读 | qps: 627000（服务器512G内存，全部内存命中） | qps: 64979 （服务器192G内存，命中非常低）| qps: 37253 （服务器192G内存，命中非常低）  
10亿读写 | tps  31545 , qps  157725 | tps 25595 ，qps 127975 | tps 28627 , qps 143135   
  
### PostgreSQL tpcb 100亿数据量 测试，数据库综合性能    
    
test case | 本地ssd 1.8T\*8 | essd pl3 1.8T\*8 | essd pl3 20T    
---|---|---|---    
100亿 写入 | 9486秒 | 8195秒 | 7983秒    
100亿 只读 | qps: 158451 | qps: 21123 | qps: 22504  
100亿 读写 | tps  24720 , qps 123600 | tps  17243 , qps 86215 | tps  17087 , qps 85435      
