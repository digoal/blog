...
```  
db1=# create table t1 (id int primary key, info text, crt_time timestamp, mod_time timestamp GENERATED ALWAYS AS (im_now()) stored);  
CREATE TABLE  
db1=#   
...
```  
db1=# create table t(id int primary key, info text, crt_time timestamp, mod_time int8 GENERATED ALWAYS AS IDENTITY);  
CREATE TABLE  
...
create table t2 (id int primary key, info text, crt_time timestamp, mod_time int8 GENERATED ALWAYS AS (im_seq()) stored);  
