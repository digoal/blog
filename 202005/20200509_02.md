...
select datname,usename,xact_start,query_start,backend_xid,backend_xmin,now()-xact_start,txid_current()-least(backend_xid::text::int8,backend_xmin::text::int8),query from pg_stat_activity order by least(backend_xid::text::int8,backend_xmin::text::int8) limit 2;  
