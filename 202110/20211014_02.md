...
虽然yugabyte是云原生分布式架构, 但是yugabyte主打的并不是AP也不是HTAP, 就是纯粹的mission-critical TP业务(根据IDC报告2020 OLTP全球市场约占72.3%). 因为:     
- 1、HTAP的市场空间还非常小. 根据IDC报告, HTAP市场仅占 3.5%     
- 2、AP的话通常来讲在企业中的在线级别较低, 迁移代价低, 产品可替代性比较强.     
