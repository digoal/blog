## network block device(nbd) 共享网络块设备   
...
## 一、部署环境  
1台server(2块100G云盘), 2台client. centos 7.9环境.   
...
```  
/usr/src/kernels/linux-3.10.0-1160.el7/include/linux/blkdev.h 定义 REQ_TYPE_SPECIAL = 7  
...
```  
[root@iZbp1eo3op9s5gxnvc7aolZ linux-3.10.0-1160.el7]# dd if=/dev/zero of=/data01/test oflag=direct bs=1M count=1000  
1000+0 records in  
1000+0 records out  
1048576000 bytes (1.0 GB) copied, 4.90611 s, 214 MB/s  
  
[root@iZbp1eo3op9s5gxnvc7aolZ linux-3.10.0-1160.el7]# dd if=/dev/zero of=/data02/test oflag=direct bs=1M count=1000  
1000+0 records in  
1000+0 records out  
1048576000 bytes (1.0 GB) copied, 4.90611 s, 214 MB/s  
```  
