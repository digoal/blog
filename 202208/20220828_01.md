...
copy (select query from tpch_queries() where query_nr=1) to 'tpch.sql1' with (quote '');  
copy (select query from tpch_queries() where query_nr=2) to 'tpch.sql2' with (quote '');  
copy (select query from tpch_queries() where query_nr=3) to 'tpch.sql3' with (quote '');  
copy (select query from tpch_queries() where query_nr=4) to 'tpch.sql4' with (quote '');  
copy (select query from tpch_queries() where query_nr=5) to 'tpch.sql5' with (quote '');  
copy (select query from tpch_queries() where query_nr=6) to 'tpch.sql6' with (quote '');  
...  
copy (select query from tpch_queries() where query_nr=22) to 'tpch.sql22' with (quote '');  
