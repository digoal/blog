...
这个镜像集成了181个扩展插件, 提升业务开发效率, 解决业务问题等, 涉及各个领域, 参考末尾介绍. 以及若干数据库管理工具(例如pg_rman, pgpool等).  
...
address_standardizer                            imgsmlr                                         pg_prewarm                                      postgis
"address_standardizer-3"                        insert_username                                 pg_profile                                      "postgis-3"
address_standardizer_data_us                    intagg                                          pg_qualstats                                    postgis_raster
"address_standardizer_data_us-3"                intarray                                        pg_query_rewrite                                "postgis_raster-3"
adminpack                                       ip4r                                            pg_rational                                     postgis_sfcgal
age                                             isn                                             pg_repack                                       "postgis_sfcgal-3"
aggs_for_vecs                                   jsonb_plpython3u                                pgroonga                                        postgis_tiger_geocoder
amcheck                                         jsquery                                         pgroonga_database                               "postgis_tiger_geocoder-3"
anon                                            lantern                                         pgrouting                                       postgis_topology
autoinc                                         lo                                              pgrowlocks                                      "postgis_topology-3"
aws_s3                                          ltree                                           pg_safer_settings                               postgres_fdw
bloom                                           ltree_plpython3u                                pg_safer_settings_table_dependent_extension     powa
btree_gin                                       mimeo                                           pg_safer_settings_table_dependent_subextension  prefix
btree_gist                                      moddatetime                                     pgsentinel                                      pre_prepare
...
earthdistance                                   pg_cron                                         pg_tiktoken                                     tdigest
embedding                                       pgcrypto                                        pg_track_settings                               tds_fdw
extra_window_functions                          pg_curl                                         pg_trgm                                         temporal_tables
file_fdw                                        pg_dbms_stats                                   pgtt                                            timescaledb
first_last_agg                                  pg_dirtyread                                    pg_utility_trigger_functions                    timescaledb_toolkit
fuzzystrmatch                                   pgfaceting                                      pg_variables                                    toastinfo
gevel                                           pgfincore                                       pg_visibility                                   tsm_system_rows
h3                                              pg_freespacemap                                 pg_wait_sampling                                tsm_system_time
h3_postgis                                      pggraphblas                                     pldbgapi                                        unaccent
hdfs_fdw                                        pg_hint_plan                                    pljava                                          unit
hll                                             pg_ivm                                          pllua                                           "uuid-ossp"
hnsw                                            pg_jieba                                        plluau                                          vector
hstore                                          pgjwt                                           plpgsql_check                                   vops
hstore_pllua                                    pgmemcache                                      plprofiler                                      xml2
hstore_plluau                                   pgmp                                            plproxy                                         zhparser
hstore_plpython3u                               pg_net                                          plpython3u                                      zson
http                                            pgpool_adm                                      plr                                             
hypopg                                          pgpool_recovery                                 pointcloud                                      
icu_ext                                         pgpool_regclass                                 pointcloud_postgis
```  
...
COPY GraphBLAS-3.1.1.tar.gz libduckdb-linux-amd64.zip duckdb_cli-linux-amd64.zip cmake-3.27.4.tar.gz mongo-c-driver-1.17.3.tar.gz json-c-0.15-20200726.tar.gz pg_tiktoken--0.0.1.sql pg_tiktoken.control pg_tiktoken.so $TEMP_DIR/
