...
这个镜像集成了189个扩展插件, 提升业务开发效率, 解决业务问题等, 涉及各个领域, 参考末尾介绍. 以及若干数据库管理工具(例如pg_rman, pgpool等).  
...
address_standardizer                            insert_username                                 pgpool_regclass                                 pointcloud_postgis
"address_standardizer-3"                        intagg                                          pg_prewarm                                      postgis
address_standardizer_data_us                    intarray                                        pg_profile                                      "postgis-3"
"address_standardizer_data_us-3"                ip4r                                            pg_qualstats                                    postgis_raster
adminpack                                       isn                                             pg_query_rewrite                                "postgis_raster-3"
age                                             jsonb_plpython3u                                pg_rational                                     postgis_sfcgal
aggs_for_vecs                                   jsquery                                         pg_repack                                       "postgis_sfcgal-3"
amcheck                                         lantern                                         pgroonga                                        postgis_tiger_geocoder
anon                                            lantern_extras                                  pgroonga_database                               "postgis_tiger_geocoder-3"
...
citext                                          mongo_fdw                                       pg_search                                       pre_prepare
citus                                           mysql_fdw                                       pgsentinel                                      prioritize
citus_columnar                                  ogr_fdw                                         pg_show_plans                                   q3c
columnar                                        old_snapshot                                    pg_similarity                                   quantile
credcheck                                       oracle_fdw                                      pgsodium                                        rdkit
cube                                            orafce                                          pg_sphere                                       refint
datasketches                                    pageinspect                                     pg_squeeze                                      roaringbitmap
dblink                                          parquet_fdw                                     pg_stat_kcache                                  rum
dblink_plus                                     parray_gin                                      pg_stat_monitor                                 seg
ddlx                                            pgagent                                         pg_stat_statements                              smlar
decoderbufs                                     pgaudit                                         pgstattuple                                     sqlite_fdw
dict_int                                        pg_bigm                                         pg_statviz                                      sslinfo
dict_xsyn                                       pg_bm25                                         pg_store_plans                                  tablefunc
...
imgsmlr                                         pgpool_recovery                                 pointcloud
```  
...
cd $TEMP_DIR  
git clone --depth 1 -b extension https://github.com/RekGRpth/pg_task/tree/extension
# OR
# git clone --depth 1 -b extension https://github.com/RekGRpth/pg_task/tree/extension  
# cd $TEMP_DIR/pg_task  
# USE_PGXS=1 make install
