...
address_standardizer                            pg4ml                                           pg_tiktoken
"address_standardizer-3"                        pgagent                                         pg_track_settings
...
duckdb_fdw                                      pg_migrate                                      "postgis_sfcgal-3"
earthdistance                                   pgmp                                            postgis_tiger_geocoder
embedding                                       pgmq                                            "postgis_tiger_geocoder-3"
extra_window_functions                          pg_nanoid                                       postgis_topology
file_fdw                                        pg_net                                          "postgis_topology-3"
first_last_agg                                  pg_onnx                                         postgres_fdw
fuzzystrmatch                                   pg_partman                                      powa
gevel                                           pgpcre                                          prefix
h3                                              pgpool_adm                                      pre_prepare
h3_postgis                                      pgpool_recovery                                 prioritize
hdfs_fdw                                        pgpool_regclass                                 q3c
hll                                             pg_prewarm                                      quantile
hnsw                                            pg_proctab                                      rdkit
hstore                                          pg_profile                                      refint
hstore_pllua                                    pg_qualstats                                    roaringbitmap
hstore_plluau                                   pg_query_rewrite                                rum
hstore_plpython3u                               pg_rational                                     seg
http                                            pg_repack                                       smlar
hypopg                                          pgroonga                                        snowflake
icu_ext                                         pgroonga_database                               sqlite_fdw
imgsmlr                                         pgrouting                                       sslinfo
influxdb_fdw                                    pgrowlocks                                      supa_audit
...
ip4r                                            pg_savior                                       tcn
isn                                             pg_search                                       tdigest
jsonb_plpython3u                                pgsentinel                                      tds_fdw
jsquery                                         pg_show_plans                                   temporal_tables
lantern                                         pg_similarity                                   timescaledb
lantern_extras                                  pgsodium                                        timescaledb_toolkit
lo                                              pg_sparse                                       toastinfo
ltree                                           pg_sphere                                       tsm_system_rows
ltree_plpython3u                                pg_squeeze                                      tsm_system_time
mimeo                                           pg_stat_kcache                                  uint
mobilitydb                                      pg_stat_monitor                                 ulid
moddatetime                                     pg_stat_statements                              unaccent
mongo_fdw                                       pgstattuple                                     unit
mysql_fdw                                       pg_statviz                                      "uuid-ossp"
ogr_fdw                                         pg_store_plans                                  vector
old_snapshot                                    pg_subtrans_infos                               vectorize
oracle_fdw                                      pg_subxact_counters                             vops
orafce                                          pg_surgery                                      walminer
pageinspect                                     pgtap                                           xml2
parquet_fdw                                     pg_task                                         zhparser
parray_gin                                      pgtelemetry                                     zson
```  
...
# key value 可能经常变化, 需要关注以上URL进行更新. 
...
PostgreSQL发行版
- HaloDB, 杭州羲和数据发布的兼容PostgreSQL(协议级兼容), MySQL(协议级兼容), Oracle的数据库. 感谢章老哥提供二进制包和试用许可. su - halo 即可使用. 更多请参考halo的官方文档.   
