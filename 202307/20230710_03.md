...
这个镜像集成了205个扩展插件, 提升业务开发效率, 解决业务问题等, 涉及各个领域, 参考末尾介绍. 以及若干数据库管理工具(例如pg_rman, pgpool等).  
...
address_standardizer                            pageinspect                                     pg_track_settings
"address_standardizer-3"                        parquet_fdw                                     pg_trgm
address_standardizer_data_us                    parray_gin                                      pgtt
"address_standardizer_data_us-3"                pgagent                                         pg_utility_trigger_functions
adminpack                                       pgaudit                                         pg_uuidv7
age                                             pgautofailover                                  pg_variables
aggs_for_vecs                                   pg_bigm                                         pg_visibility
amcheck                                         pg_bm25                                         pg_wait_sampling
anon                                            pg_buffercache                                  pipelinedb
autoinc                                         pg_bulkload                                     pldbgapi
aws_s3                                          pg_cron                                         pljava
bloom                                           pgcrypto                                        pllua
btree_gin                                       pg_curl                                         plluau
btree_gist                                      pg_dbms_stats                                   plpgsql_check
citext                                          pgdd                                            plprofiler
citus                                           pg_dirtyread                                    plproxy
citus_columnar                                  pgfaceting                                      plpython3u
columnar                                        pgfincore                                       plr
credcheck                                       pg_freespacemap                                 pointcloud
cube                                            pggraphblas                                     pointcloud_postgis
datasketches                                    pg_hint_plan                                    postgis
dblink                                          pg_idkit                                        "postgis-3"
dblink_plus                                     pg_ivm                                          postgis_raster
ddlx                                            pg_jieba                                        "postgis_raster-3"
decoderbufs                                     pgjwt                                           postgis_sfcgal
dict_int                                        pgmemcache                                      "postgis_sfcgal-3"
dict_xsyn                                       pgmp                                            postgis_tiger_geocoder
duckdb_fdw                                      pg_nanoid                                       "postgis_tiger_geocoder-3"
earthdistance                                   pg_net                                          postgis_topology
embedding                                       pg_onnx                                         "postgis_topology-3"
extra_window_functions                          pg_partman                                      postgres_fdw
file_fdw                                        pgpool_adm                                      powa
first_last_agg                                  pgpool_recovery                                 prefix
fuzzystrmatch                                   pgpool_regclass                                 pre_prepare
gevel                                           pg_prewarm                                      prioritize
h3                                              pg_proctab                                      q3c
h3_postgis                                      pg_profile                                      quantile
hdfs_fdw                                        pg_qualstats                                    rdkit
hll                                             pg_query_rewrite                                refint
hnsw                                            pg_rational                                     roaringbitmap
hstore                                          pg_repack                                       rum
hstore_pllua                                    pgroonga                                        seg
hstore_plluau                                   pgroonga_database                               smlar
hstore_plpython3u                               pgrouting                                       sqlite_fdw
http                                            pgrowlocks                                      sslinfo
hypopg                                          pg_safer_settings                               svector
icu_ext                                         pg_safer_settings_table_dependent_extension     tablefunc
imgsmlr                                         pg_safer_settings_table_dependent_subextension  table_log
insert_username                                 pg_search                                       tcn
intagg                                          pgsentinel                                      tdigest
intarray                                        pg_show_plans                                   tds_fdw
ip4r                                            pg_similarity                                   temporal_tables
isn                                             pgsodium                                        timescaledb
jsonb_plpython3u                                pg_sparse                                       timescaledb_toolkit
jsquery                                         pg_sphere                                       toastinfo
lantern                                         pg_squeeze                                      tsm_system_rows
lantern_extras                                  pg_stat_kcache                                  tsm_system_time
lo                                              pg_stat_monitor                                 uint
ltree                                           pg_stat_statements                              ulid
