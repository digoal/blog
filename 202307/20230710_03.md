...
这个镜像集成了179个扩展插件, 提升业务开发效率, 解决业务问题等, 涉及各个领域, 参考末尾介绍. 以及若干数据库管理工具(例如pg_rman, pgpool等).  
...
address_standardizer                            icu_ext                                         pgpool_regclass                                 pointcloud_postgis
"address_standardizer-3"                        imgsmlr                                         pg_prewarm                                      postgis
address_standardizer_data_us                    insert_username                                 pg_profile                                      "postgis-3"
"address_standardizer_data_us-3"                intagg                                          pg_qualstats                                    postgis_raster
adminpack                                       intarray                                        pg_query_rewrite                                "postgis_raster-3"
age                                             ip4r                                            pg_rational                                     postgis_sfcgal
aggs_for_vecs                                   isn                                             pg_repack                                       "postgis_sfcgal-3"
amcheck                                         jsonb_plpython3u                                pgroonga                                        postgis_tiger_geocoder
anon                                            jsquery                                         pgroonga_database                               "postgis_tiger_geocoder-3"
autoinc                                         lo                                              pgrouting                                       postgis_topology
aws_s3                                          ltree                                           pgrowlocks                                      "postgis_topology-3"
bloom                                           ltree_plpython3u                                pg_safer_settings                               postgres_fdw
btree_gin                                       mimeo                                           pg_safer_settings_table_dependent_extension     powa
btree_gist                                      moddatetime                                     pg_safer_settings_table_dependent_subextension  prefix
citext                                          mongo_fdw                                       pgsentinel                                      pre_prepare
citus                                           mysql_fdw                                       pg_show_plans                                   prioritize
citus_columnar                                  ogr_fdw                                         pg_similarity                                   q3c
...
dblink_plus                                     parray_gin                                      pg_stat_monitor                                 rum
ddlx                                            pgagent                                         pg_stat_statements                              seg
decoderbufs                                     pgaudit                                         pgstattuple                                     smlar
dict_int                                        pg_bigm                                         pg_statviz                                      sslinfo
dict_xsyn                                       pg_buffercache                                  pg_store_plans                                  tablefunc
duckdb_fdw                                      pg_bulkload                                     pg_surgery                                      table_log
earthdistance                                   pg_cron                                         pgtap                                           tcn
embedding                                       pgcrypto                                        pg_track_settings                               tdigest
extra_window_functions                          pg_curl                                         pg_trgm                                         tds_fdw
file_fdw                                        pg_dbms_stats                                   pgtt                                            temporal_tables
first_last_agg                                  pg_dirtyread                                    pg_utility_trigger_functions                    timescaledb
fuzzystrmatch                                   pgfaceting                                      pg_variables                                    timescaledb_toolkit
gevel                                           pgfincore                                       pg_visibility                                   toastinfo
h3                                              pg_freespacemap                                 pg_wait_sampling                                tsm_system_rows
h3_postgis                                      pggraphblas                                     pldbgapi                                        tsm_system_time
hdfs_fdw                                        pg_hint_plan                                    pljava                                          unaccent
hll                                             pg_ivm                                          pllua                                           unit
hnsw                                            pg_jieba                                        plluau                                          "uuid-ossp"
hstore                                          pgjwt                                           plpgsql_check                                   vector
hstore_pllua                                    pgmemcache                                      plprofiler                                      vops
hstore_plluau                                   pgmp                                            plproxy                                         xml2
hstore_plpython3u                               pg_net                                          plpython3u                                      zhparser
http                                            pgpool_adm                                      plr                                             zson
hypopg                                          pgpool_recovery                                 pointcloud  
```  
