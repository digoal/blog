...
这个镜像集成了182个扩展插件, 提升业务开发效率, 解决业务问题等, 涉及各个领域, 参考末尾介绍. 以及若干数据库管理工具(例如pg_rman, pgpool等).  
...
credcheck                                       ogr_fdw                                         pgsodium                                        quantile
cube                                            old_snapshot                                    pg_sphere                                       rdkit
datasketches                                    oracle_fdw                                      pg_squeeze                                      refint
dblink                                          orafce                                          pg_stat_kcache                                  roaringbitmap
dblink_plus                                     pageinspect                                     pg_stat_monitor                                 rum
...
gevel                                           pgfaceting                                      pg_variables                                    toastinfo
h3                                              pgfincore                                       pg_visibility                                   tsm_system_rows
h3_postgis                                      pg_freespacemap                                 pg_wait_sampling                                tsm_system_time
hdfs_fdw                                        pggraphblas                                     pldbgapi                                        unaccent
hll                                             pg_hint_plan                                    pljava                                          unit
hnsw                                            pg_ivm                                          pllua                                           "uuid-ossp"
hstore                                          pg_jieba                                        plluau                                          vector
hstore_pllua                                    pgjwt                                           plpgsql_check                                   vops
hstore_plluau                                   pgmemcache                                      plprofiler                                      xml2
hstore_plpython3u                               pgmp                                            plproxy                                         zhparser
http                                            pg_net                                          plpython3u                                      zson
