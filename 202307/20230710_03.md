...
这个镜像集成了193个扩展插件, 提升业务开发效率, 解决业务问题等, 涉及各个领域, 参考末尾介绍. 以及若干数据库管理工具(例如pg_rman, pgpool等).  
...
address_standardizer                            intagg                                          pg_proctab                                      pointcloud
"address_standardizer-3"                        intarray                                        pg_profile                                      pointcloud_postgis
address_standardizer_data_us                    ip4r                                            pg_qualstats                                    postgis
"address_standardizer_data_us-3"                isn                                             pg_query_rewrite                                "postgis-3"
adminpack                                       jsonb_plpython3u                                pg_rational                                     postgis_raster
age                                             jsquery                                         pg_repack                                       "postgis_raster-3"
aggs_for_vecs                                   lantern                                         pgroonga                                        postgis_sfcgal
amcheck                                         lantern_extras                                  pgroonga_database                               "postgis_sfcgal-3"
anon                                            lo                                              pgrouting                                       postgis_tiger_geocoder
autoinc                                         ltree                                           pgrowlocks                                      "postgis_tiger_geocoder-3"
aws_s3                                          ltree_plpython3u                                pg_safer_settings                               postgis_topology
bloom                                           mimeo                                           pg_safer_settings_table_dependent_extension     "postgis_topology-3"
btree_gin                                       moddatetime                                     pg_safer_settings_table_dependent_subextension  postgres_fdw
btree_gist                                      mongo_fdw                                       pg_search                                       powa
citext                                          mysql_fdw                                       pgsentinel                                      prefix
citus                                           ogr_fdw                                         pg_show_plans                                   pre_prepare
citus_columnar                                  old_snapshot                                    pg_similarity                                   prioritize
columnar                                        oracle_fdw                                      pgsodium                                        q3c
credcheck                                       orafce                                          pg_sparse                                       quantile
cube                                            pageinspect                                     pg_sphere                                       rdkit
datasketches                                    parquet_fdw                                     pg_squeeze                                      refint
dblink                                          parray_gin                                      pg_stat_kcache                                  roaringbitmap
dblink_plus                                     pgagent                                         pg_stat_monitor                                 rum
ddlx                                            pgaudit                                         pg_stat_statements                              seg
decoderbufs                                     pg_bigm                                         pgstattuple                                     smlar
dict_int                                        pg_bm25                                         pg_statviz                                      sqlite_fdw
dict_xsyn                                       pg_buffercache                                  pg_store_plans                                  sslinfo
duckdb_fdw                                      pg_bulkload                                     pg_surgery                                      tablefunc
earthdistance                                   pg_cron                                         pgtap                                           table_log
embedding                                       pgcrypto                                        pg_task                                         tcn
extra_window_functions                          pg_curl                                         pgtelemetry                                     tdigest
file_fdw                                        pg_dbms_stats                                   pg_tiktoken                                     tds_fdw
first_last_agg                                  pg_dirtyread                                    pg_track_settings                               temporal_tables
fuzzystrmatch                                   pgfaceting                                      pg_trgm                                         timescaledb
gevel                                           pgfincore                                       pgtt                                            timescaledb_toolkit
h3                                              pg_freespacemap                                 pg_utility_trigger_functions                    toastinfo
h3_postgis                                      pggraphblas                                     pg_uuidv7                                       tsm_system_rows
hdfs_fdw                                        pg_hint_plan                                    pg_variables                                    tsm_system_time
hll                                             pg_ivm                                          pg_visibility                                   unaccent
hnsw                                            pg_jieba                                        pg_wait_sampling                                unit
hstore                                          pgjwt                                           pldbgapi                                        "uuid-ossp"
hstore_pllua                                    pgmemcache                                      pljava                                          vector
hstore_plluau                                   pgmp                                            pllua                                           vops
hstore_plpython3u                               pg_net                                          plluau                                          xml2
http                                            pg_onnx                                         plpgsql_check                                   zhparser
hypopg                                          pgpool_adm                                      plprofiler                                      zson
icu_ext                                         pgpool_recovery                                 plproxy                                         
imgsmlr                                         pgpool_regclass                                 plpython3u                                      
insert_username                                 pg_prewarm                                      plr 
```  
...
apt-get install -y postgresql-14-credcheck postgresql-14-decoderbufs postgresql-14-mimeo postgresql-14-pgmp postgresql-14-preprepare postgresql-14-prioritize postgresql-14-squeeze postgresql-14-toastinfo postgresql-14-unit pgbadger pg-auto-failover-cli postgresql-14-auto-failover 
```  
...
# pghero 目前仅支持x86版本
# 并且 https://dl.packager.io/srv/pghero/pghero/key 需要开网络授权, 否则无法访问. 
cd $TEMP_DIR/
