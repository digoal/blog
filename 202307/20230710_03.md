...
这个镜像集成了185个扩展插件, 提升业务开发效率, 解决业务问题等, 涉及各个领域, 参考末尾介绍. 以及若干数据库管理工具(例如pg_rman, pgpool等).  
...
address_standardizer                            imgsmlr                                         pgpool_regclass                                 pointcloud_postgis
"address_standardizer-3"                        insert_username                                 pg_prewarm                                      postgis
address_standardizer_data_us                    intagg                                          pg_profile                                      "postgis-3"
"address_standardizer_data_us-3"                intarray                                        pg_qualstats                                    postgis_raster
adminpack                                       ip4r                                            pg_query_rewrite                                "postgis_raster-3"
age                                             isn                                             pg_rational                                     postgis_sfcgal
aggs_for_vecs                                   jsonb_plpython3u                                pg_repack                                       "postgis_sfcgal-3"
amcheck                                         jsquery                                         pgroonga                                        postgis_tiger_geocoder
anon                                            lantern                                         pgroonga_database                               "postgis_tiger_geocoder-3"
autoinc                                         lantern_extras                                  pgrouting                                       postgis_topology
aws_s3                                          lo                                              pgrowlocks                                      "postgis_topology-3"
bloom                                           ltree                                           pg_safer_settings                               postgres_fdw
btree_gin                                       ltree_plpython3u                                pg_safer_settings_table_dependent_extension     powa
btree_gist                                      mimeo                                           pg_safer_settings_table_dependent_subextension  prefix
citext                                          moddatetime                                     pgsentinel                                      pre_prepare
citus                                           mongo_fdw                                       pg_show_plans                                   prioritize
citus_columnar                                  mysql_fdw                                       pg_similarity                                   q3c
columnar                                        ogr_fdw                                         pgsodium                                        quantile
...
fuzzystrmatch                                   pgfaceting                                      pg_uuidv7                                       toastinfo
gevel                                           pgfincore                                       pg_variables                                    tsm_system_rows
h3                                              pg_freespacemap                                 pg_visibility                                   tsm_system_time
h3_postgis                                      pggraphblas                                     pg_wait_sampling                                unaccent
hdfs_fdw                                        pg_hint_plan                                    pldbgapi                                        unit
hll                                             pg_ivm                                          pljava                                          "uuid-ossp"
hnsw                                            pg_jieba                                        pllua                                           vector
hstore                                          pgjwt                                           plluau                                          vops
hstore_pllua                                    pgmemcache                                      plpgsql_check                                   xml2
hstore_plluau                                   pgmp                                            plprofiler                                      zhparser
hstore_plpython3u                               pg_net                                          plproxy                                         zson
http                                            pg_onnx                                         plpython3u                                      
hypopg                                          pgpool_adm                                      plr                                             
icu_ext                                         pgpool_recovery                                 pointcloud 
```  
...
# bug修复之前 :  https://github.com/s-hironobu/pg_plan_inspector/issues/1 
