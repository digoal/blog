...
这个镜像集成了201个扩展插件, 提升业务开发效率, 解决业务问题等, 涉及各个领域, 参考末尾介绍. 以及若干数据库管理工具(例如pg_rman, pgpool等).  
...
address_standardizer                            oracle_fdw                                      pgtelemetry
"address_standardizer-3"                        orafce                                          pg_tiktoken
address_standardizer_data_us                    pageinspect                                     pg_track_settings
"address_standardizer_data_us-3"                parquet_fdw                                     pg_trgm
adminpack                                       parray_gin                                      pgtt
age                                             pgagent                                         pg_utility_trigger_functions
aggs_for_vecs                                   pgaudit                                         pg_uuidv7
amcheck                                         pgautofailover                                  pg_variables
anon                                            pg_bigm                                         pg_visibility
autoinc                                         pg_bm25                                         pg_wait_sampling
aws_s3                                          pg_buffercache                                  pldbgapi
bloom                                           pg_bulkload                                     pljava
btree_gin                                       pg_cron                                         pllua
btree_gist                                      pgcrypto                                        plluau
citext                                          pg_curl                                         plpgsql_check
citus                                           pg_dbms_stats                                   plprofiler
citus_columnar                                  pgdd                                            plproxy
columnar                                        pg_dirtyread                                    plpython3u
credcheck                                       pgfaceting                                      plr
cube                                            pgfincore                                       pointcloud
datasketches                                    pg_freespacemap                                 pointcloud_postgis
dblink                                          pggraphblas                                     postgis
dblink_plus                                     pg_hint_plan                                    "postgis-3"
ddlx                                            pg_idkit                                        postgis_raster
decoderbufs                                     pg_ivm                                          "postgis_raster-3"
dict_int                                        pg_jieba                                        postgis_sfcgal
dict_xsyn                                       pgjwt                                           "postgis_sfcgal-3"
duckdb_fdw                                      pgmemcache                                      postgis_tiger_geocoder
earthdistance                                   pgmp                                            "postgis_tiger_geocoder-3"
embedding                                       pg_net                                          postgis_topology
extra_window_functions                          pg_onnx                                         "postgis_topology-3"
file_fdw                                        pgpool_adm                                      postgres_fdw
first_last_agg                                  pgpool_recovery                                 powa
fuzzystrmatch                                   pgpool_regclass                                 prefix
gevel                                           pg_prewarm                                      pre_prepare
h3                                              pg_proctab                                      prioritize
h3_postgis                                      pg_profile                                      q3c
hdfs_fdw                                        pg_qualstats                                    quantile
hll                                             pg_query_rewrite                                rdkit
hnsw                                            pg_rational                                     refint
hstore                                          pg_repack                                       roaringbitmap
hstore_pllua                                    pgroonga                                        rum
hstore_plluau                                   pgroonga_database                               seg
hstore_plpython3u                               pgrouting                                       smlar
http                                            pgrowlocks                                      sqlite_fdw
hypopg                                          pg_safer_settings                               sslinfo
icu_ext                                         pg_safer_settings_table_dependent_extension     svector
imgsmlr                                         pg_safer_settings_table_dependent_subextension  tablefunc
insert_username                                 pg_search                                       table_log
intagg                                          pgsentinel                                      tcn
intarray                                        pg_show_plans                                   tdigest
ip4r                                            pg_similarity                                   tds_fdw
isn                                             pgsodium                                        temporal_tables
jsonb_plpython3u                                pg_sparse                                       timescaledb
jsquery                                         pg_sphere                                       timescaledb_toolkit
lantern                                         pg_squeeze                                      toastinfo
lantern_extras                                  pg_stat_kcache                                  tsm_system_rows
lo                                              pg_stat_monitor                                 tsm_system_time
ltree                                           pg_stat_statements                              uint
ltree_plpython3u                                pgstattuple                                     unaccent
mimeo                                           pg_statviz                                      unit
mobilitydb                                      pg_store_plans                                  "uuid-ossp"
moddatetime                                     pg_subtrans_infos                               vector
mongo_fdw                                       pg_subxact_counters                             vops
mysql_fdw                                       pg_surgery                                      xml2
ogr_fdw                                         pgtap                                           zhparser
old_snapshot                                    pg_task                                         zson
```  
...
pghero直接下载DEB:
```
pghero 网络问题导致无法apt安装, 直接下载.  pghero_3.4.0-1701207987.0382b812.bullseye_amd64.deb

[《macOS 通过“oversea region ECS和ssh隧道转发代理请求” OR “openVPN” 提升github等访问体验 - chrome Proxy SwitchyOmega , cli ... 可用》](../202310/20231029_01.md)  


#11 3885.7 + apt-get -y install pghero
#11 3885.9 Reading package lists...
#11 3887.5 Building dependency tree...
#11 3887.8 Reading state information...
#11 3888.1 The following NEW packages will be installed:
#11 3888.1   pghero
#11 4182.4 0 upgraded, 1 newly installed, 0 to remove and 11 not upgraded.
...
- pgbackrest, 备份管理工具.
- elephant-shed-pgbackrest, PG备份管理工具pgbackrest web控制台, 同时也即成了一些其他有趣的工具
