...
- databend (datalake/数据湖产品, data warehouse as code, 由各种rust开源组件SQL解析、优化器、存储格式、存储引擎拼装起来.)  https://docs.databend.com/guides/deploy/deploying-local   
