...
这个镜像集成了168个扩展插件, 提升业务开发效率, 解决业务问题等, 涉及各个领域, 参考末尾介绍. 以及若干数据库管理工具(例如pg_rman, pgpool等).  
...
address_standardizer                            hypopg                                          pgpool_adm                                      plpython3u
"address_standardizer-3"                        icu_ext                                         pgpool_recovery                                 plr
address_standardizer_data_us                    imgsmlr                                         pgpool_regclass                                 pointcloud
"address_standardizer_data_us-3"                insert_username                                 pg_prewarm                                      pointcloud_postgis
adminpack                                       intagg                                          pg_profile                                      postgis
age                                             intarray                                        pg_qualstats                                    "postgis-3"
aggs_for_vecs                                   ip4r                                            pg_query_rewrite                                postgis_raster
amcheck                                         isn                                             pg_rational                                     "postgis_raster-3"
anon                                            jsonb_plpython3u                                pg_repack                                       postgis_sfcgal
autoinc                                         jsquery                                         pgroonga                                        "postgis_sfcgal-3"
aws_s3                                          lo                                              pgroonga_database                               postgis_tiger_geocoder
bloom                                           ltree                                           pgrouting                                       "postgis_tiger_geocoder-3"
btree_gin                                       ltree_plpython3u                                pgrowlocks                                      postgis_topology
btree_gist                                      moddatetime                                     pg_safer_settings                               "postgis_topology-3"
citext                                          mongo_fdw                                       pg_safer_settings_table_dependent_extension     postgres_fdw
citus                                           mysql_fdw                                       pg_safer_settings_table_dependent_subextension  powa
citus_columnar                                  ogr_fdw                                         pg_show_plans                                   prefix
cube                                            old_snapshot                                    pg_similarity                                   q3c
datasketches                                    oracle_fdw                                      pgsodium                                        quantile
dblink                                          orafce                                          pg_sphere                                       rdkit
dblink_plus                                     pageinspect                                     pg_stat_kcache                                  refint
ddlx                                            parray_gin                                      pg_stat_monitor                                 roaringbitmap
dict_int                                        pgagent                                         pg_stat_statements                              rum
dict_xsyn                                       pgaudit                                         pgstattuple                                     seg
duckdb_fdw                                      pg_bigm                                         pg_statviz                                      smlar
earthdistance                                   pg_buffercache                                  pg_store_plans                                  sslinfo
embedding                                       pg_bulkload                                     pg_surgery                                      tablefunc
extra_window_functions                          pg_cron                                         pgtap                                           table_log
file_fdw                                        pgcrypto                                        pg_track_settings                               tcn
first_last_agg                                  pg_curl                                         pg_trgm                                         tdigest
fuzzystrmatch                                   pg_dbms_stats                                   pgtt                                            tds_fdw
gevel                                           pg_dirtyread                                    pg_utility_trigger_functions                    temporal_tables
h3                                              pgfaceting                                      pg_variables                                    timescaledb
h3_postgis                                      pgfincore                                       pg_visibility                                   timescaledb_toolkit
hdfs_fdw                                        pg_freespacemap                                 pg_wait_sampling                                tsm_system_rows
hll                                             pggraphblas                                     pldbgapi                                        tsm_system_time
hnsw                                            pg_hint_plan                                    pljava                                          unaccent
hstore                                          pg_ivm                                          pllua                                           "uuid-ossp"
hstore_pllua                                    pg_jieba                                        plluau                                          vector
hstore_plluau                                   pgjwt                                           plpgsql_check                                   vops
hstore_plpython3u                               pgmemcache                                      plprofiler                                      xml2
http                                            pg_net                                          plproxy                                         zhparser
```  
...
- Apache Arrow Flight SQL adapter, arrow 协议, 可使用arrow driver连接. (未集成)
