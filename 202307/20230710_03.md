...
这个镜像集成了164个扩展插件, 提升业务开发效率, 解决业务问题等, 涉及各个领域, 参考末尾介绍. 以及若干数据库管理工具(例如pg_rman, pgpool等).  
...
address_standardizer                            hypopg                                          pgpool_recovery                                 plpython3u
"address_standardizer-3"                        icu_ext                                         pgpool_regclass                                 plr
address_standardizer_data_us                    imgsmlr                                         pg_prewarm                                      pointcloud
"address_standardizer_data_us-3"                insert_username                                 pg_profile                                      pointcloud_postgis
adminpack                                       intagg                                          pg_qualstats                                    postgis
age                                             intarray                                        pg_query_rewrite                                "postgis-3"
aggs_for_vecs                                   ip4r                                            pg_rational                                     postgis_raster
amcheck                                         isn                                             pg_repack                                       "postgis_raster-3"
anon                                            jsonb_plpython3u                                pgroonga                                        postgis_sfcgal
autoinc                                         jsquery                                         pgroonga_database                               "postgis_sfcgal-3"
aws_s3                                          lo                                              pgrouting                                       postgis_tiger_geocoder
bloom                                           ltree                                           pgrowlocks                                      "postgis_tiger_geocoder-3"
btree_gin                                       ltree_plpython3u                                pg_safer_settings                               postgis_topology
btree_gist                                      moddatetime                                     pg_safer_settings_table_dependent_extension     "postgis_topology-3"
citext                                          mongo_fdw                                       pg_safer_settings_table_dependent_subextension  postgres_fdw
citus                                           mysql_fdw                                       pg_show_plans                                   powa
citus_columnar                                  ogr_fdw                                         pg_similarity                                   prefix
cube                                            old_snapshot                                    pgsodium                                        q3c
datasketches                                    oracle_fdw                                      pg_sphere                                       quantile
dblink                                          orafce                                          pg_stat_kcache                                  rdkit
dblink_plus                                     pageinspect                                     pg_stat_monitor                                 refint
ddlx                                            parray_gin                                      pg_stat_statements                              roaringbitmap
dict_int                                        pgagent                                         pgstattuple                                     rum
dict_xsyn                                       pgaudit                                         pg_statviz                                      seg
duckdb_fdw                                      pg_bigm                                         pg_store_plans                                  smlar
earthdistance                                   pg_buffercache                                  pg_surgery                                      sslinfo
embedding                                       pg_bulkload                                     pgtap                                           tablefunc
extra_window_functions                          pg_cron                                         pg_track_settings                               table_log
file_fdw                                        pgcrypto                                        pg_trgm                                         tcn
first_last_agg                                  pg_curl                                         pgtt                                            tdigest
fuzzystrmatch                                   pg_dbms_stats                                   pg_utility_trigger_functions                    tds_fdw
gevel                                           pg_dirtyread                                    pg_variables                                    temporal_tables
h3                                              pgfaceting                                      pg_visibility                                   timescaledb
h3_postgis                                      pgfincore                                       pg_wait_sampling                                timescaledb_toolkit
hdfs_fdw                                        pg_freespacemap                                 pldbgapi                                        tsm_system_rows
hll                                             pggraphblas                                     pljava                                          tsm_system_time
hnsw                                            pg_hint_plan                                    pllua                                           unaccent
hstore                                          pg_ivm                                          plluau                                          "uuid-ossp"
hstore_pllua                                    pg_jieba                                        plpgsql_check                                   vector
hstore_plluau                                   pgmemcache                                      plprofiler                                      vops
hstore_plpython3u                               pgpool_adm                                      plproxy                                         xml2
```  
