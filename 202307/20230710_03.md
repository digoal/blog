...
这个镜像集成了198个扩展插件, 提升业务开发效率, 解决业务问题等, 涉及各个领域, 参考末尾介绍. 以及若干数据库管理工具(例如pg_rman, pgpool等).  
...
address_standardizer                            intarray                                        pg_profile                                      pointcloud
"address_standardizer-3"                        ip4r                                            pg_qualstats                                    pointcloud_postgis
address_standardizer_data_us                    isn                                             pg_query_rewrite                                postgis
"address_standardizer_data_us-3"                jsonb_plpython3u                                pg_rational                                     "postgis-3"
adminpack                                       jsquery                                         pg_repack                                       postgis_raster
age                                             lantern                                         pgroonga                                        "postgis_raster-3"
aggs_for_vecs                                   lantern_extras                                  pgroonga_database                               postgis_sfcgal
amcheck                                         lo                                              pgrouting                                       "postgis_sfcgal-3"
anon                                            ltree                                           pgrowlocks                                      postgis_tiger_geocoder
autoinc                                         ltree_plpython3u                                pg_safer_settings                               "postgis_tiger_geocoder-3"
aws_s3                                          mimeo                                           pg_safer_settings_table_dependent_extension     postgis_topology
bloom                                           moddatetime                                     pg_safer_settings_table_dependent_subextension  "postgis_topology-3"
btree_gin                                       mongo_fdw                                       pg_search                                       postgres_fdw
btree_gist                                      mysql_fdw                                       pgsentinel                                      powa
citext                                          ogr_fdw                                         pg_show_plans                                   prefix
citus                                           old_snapshot                                    pg_similarity                                   pre_prepare
citus_columnar                                  oracle_fdw                                      pgsodium                                        prioritize
columnar                                        orafce                                          pg_sparse                                       q3c
credcheck                                       pageinspect                                     pg_sphere                                       quantile
cube                                            parquet_fdw                                     pg_squeeze                                      rdkit
datasketches                                    parray_gin                                      pg_stat_kcache                                  refint
dblink                                          pgagent                                         pg_stat_monitor                                 roaringbitmap
dblink_plus                                     pgaudit                                         pg_stat_statements                              rum
ddlx                                            pgautofailover                                  pgstattuple                                     seg
decoderbufs                                     pg_bigm                                         pg_statviz                                      smlar
dict_int                                        pg_bm25                                         pg_store_plans                                  sqlite_fdw
dict_xsyn                                       pg_buffercache                                  pg_subtrans_infos                               sslinfo
duckdb_fdw                                      pg_bulkload                                     pg_subxact_counters                             svector
earthdistance                                   pg_cron                                         pg_surgery                                      tablefunc
embedding                                       pgcrypto                                        pgtap                                           table_log
extra_window_functions                          pg_curl                                         pg_task                                         tcn
file_fdw                                        pg_dbms_stats                                   pgtelemetry                                     tdigest
first_last_agg                                  pg_dirtyread                                    pg_tiktoken                                     tds_fdw
fuzzystrmatch                                   pgfaceting                                      pg_track_settings                               temporal_tables
gevel                                           pgfincore                                       pg_trgm                                         timescaledb
h3                                              pg_freespacemap                                 pgtt                                            timescaledb_toolkit
h3_postgis                                      pggraphblas                                     pg_utility_trigger_functions                    toastinfo
hdfs_fdw                                        pg_hint_plan                                    pg_uuidv7                                       tsm_system_rows
hll                                             pg_ivm                                          pg_variables                                    tsm_system_time
hnsw                                            pg_jieba                                        pg_visibility                                   uint
hstore                                          pgjwt                                           pg_wait_sampling                                unaccent
hstore_pllua                                    pgmemcache                                      pldbgapi                                        unit
hstore_plluau                                   pgmp                                            pljava                                          "uuid-ossp"
hstore_plpython3u                               pg_net                                          pllua                                           vector
http                                            pg_onnx                                         plluau                                          vops
hypopg                                          pgpool_adm                                      plpgsql_check                                   xml2
icu_ext                                         pgpool_recovery                                 plprofiler                                      zhparser
imgsmlr                                         pgpool_regclass                                 plproxy                                         zson
insert_username                                 pg_prewarm                                      plpython3u                                      
intagg                                          pg_proctab                                      plr 
```  
