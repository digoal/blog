...
apt-get install -y pgagroal pgpool2 pgbouncer pgxnclient pgagent postgresql-plpython3-14 postgresql-14-icu-ext libpq-dev pgreplay pgbackrest pgbackrest-doc elephant-shed-pgbackrest patroni 
...
cd $TEMP_DIR 
git clone --depth 1 https://github.com/pgEdge/snowflake-sequences
cd $TEMP_DIR/snowflake-sequences
USE_PGXS=1 make install
...
su - ivorysql -c " /home/ivorysql/ivorysql/bin/initdb -D /home/ivorysql/primary "
...
echo "primary_conninfo = 'host=localhost port=5281 user=ivorysql dbname=postgres application_name=standby1' " >> /home/ivorysql/primary/recovery.done
echo "# primary_slot_name = 'standby1' " >> /home/ivorysql/primary/recovery.done
echo "standby_mode = on " >> /home/ivorysql/primary/recovery.done
echo "recovery_target_timeline = 'latest' " >> /home/ivorysql/primary/recovery.done
