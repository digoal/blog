...
echo "export PATH=/usr/local/go/bin:/usr/local/go/bin:/home/neon/.cargo/bin:/tmp/cmake-3.27.9/bin:/usr/lib/postgresql/14/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin " >>/home/neon/.bashrc  
