...
cd $TEMP_DIR
cp pg_bm25--0.5.6.sql /usr/share/postgresql/14/extension/
...
cd $TEMP_DIR 
git clone --depth 1 -b v0.5.6 https://github.com/paradedb/paradedb
cd $TEMP_DIR/paradedb/pg_sparse
USE_PGXS=1 make install
chmod 644 ./sql/svector--0.5.6.sql
cp ./sql/svector--0.5.6.sql /usr/share/postgresql/14/extension/
