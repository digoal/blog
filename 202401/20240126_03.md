...
编译duckdb_fdw插件  
```
# 最新分支sqlite3_api_wrapper.cpp有错误
...
# 注意编译项 需要与 duckdb_fdw src 的 Makefile 一致.
#   区分linux/macos , 区分 arm(aarch64)和x86架构, 请仔细判断.
# macos 编译参数为 -std=c++11
# aarch64 编译参数 -std=c++11 -D_GLIBCXX_USE_CXX11_ABI=0 
# x86 为: clang++ -c -fPIC -std=c++11 duckdb.cpp -o duckdb.o  
...
认证方法password,md5,scram请参考: [《PolarDB 100 问 | 密码明明正确怎么报密码错误?》](../202412/20241226_01.md)    
