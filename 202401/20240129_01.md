...
- 使用多机并行(这个ePQ是greenplum orca优化器的适配共享存储架构的版本, OLAP业务场景优化显著), PolarDB的配置. 参考: [《开源PolarDB|PostgreSQL 应用开发者&DBA 公开课 - 5.5 PolarDB开源版本必学特性 - PolarDB 特性解读与体验》](../202401/20240125_07.md)    
