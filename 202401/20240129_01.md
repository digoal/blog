...
测试sql 17如下     
```  
./build.sh --user=postgres --db=postgres --host=/home/postgres/tmp_master_dir_polardb_pg_1100_bld --port=5432 --run=17 --option="set polar_enable_px = on; SET polar_px_dop_per_node = 2; set work_mem = '16MB';"   
```  
...
```  
cd ~/tpch-dbgen    
./build.sh --user=postgres --db=postgres --host=/tmp --port=5432 --run=17 --option="set polar_enable_px = on; SET polar_px_dop_per_node = 2; set work_mem = '16MB';"   
```  
...
```  
cd ~/tpch-dbgen    
./build.sh --user=postgres --db=postgres --host=/tmp --port=5432 --run=-1 --option="set polar_enable_px = on; SET polar_px_dop_per_node = 2; set work_mem = '16MB';"     
```  
