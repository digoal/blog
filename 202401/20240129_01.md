...
ALTER TABLE nation SET (px_workers = 7);    
ALTER TABLE region SET (px_workers = 7);    
ALTER TABLE supplier SET (px_workers = 7);    
ALTER TABLE part SET (px_workers = 7);    
ALTER TABLE partsupp SET (px_workers = 7);    
ALTER TABLE customer SET (px_workers = 7);    
ALTER TABLE orders SET (px_workers = 7);    
ALTER TABLE lineitem SET (px_workers = 7);    
\q  
```
