...
或在 Dockerfile 中使用宿主机socks5h代理
all_proxy=socks5h://host.docker.internal:11111 git clone ... 
```
...
或使用 socks5h 代理进行 clone 或 下载
all_proxy=socks5h://127.0.0.1:11111 git clone ... 
