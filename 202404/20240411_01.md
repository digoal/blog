...
由于保持了十几年跟踪`git.postgresql.org`的习惯, 在我的github里已经持续发表了PostgreSQL dev版本的新特性. 有兴趣的朋友可以关注我的github: https://github.com/digoal/blog/tree/master/202404   
  
这篇信息主要整理一下之前发布的内容, 来看看即将封版(不在接收新特性, 进入alpha,beta,release流程)的PostgreSQL 17到底值不值得期待.    
