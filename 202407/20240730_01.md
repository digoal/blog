...
要考察应聘者是否已深刻掌握xxx知识点, 可以提出哪些连贯性问题(例如在提出第1个问题后, 接下来的每个问题都是对前一个问题的深挖), 问题的难度请标记为初级、中级、高级. 问题请以如下开头:   
...
要考察应聘者是否已深刻掌握Query Tuning知识点, 可以提出哪些连贯性问题(例如在提出第1个问题后, 接下来的每个问题都是对前一个问题的深挖), 问题的难度请标记为初级、中级、高级. 问题请以如下开头:   
where is the // 去哪里找资料/代码  
What is // 名词/原理解释  
What is the difference  // 热门的差异化对比问题  
why // 为什么  
