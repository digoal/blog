...
1、下载代码  
```
git clone -c core.symlinks=true -b polardb-competition-2024 --depth 1 https://gitee.com/digoal/PolarDB-for-PostgreSQL  
cd PolarDB-for-PostgreSQL
rm -rf .git
chmod 777 *.sh
cd ..
sudo chown -R 1000:999 PolarDB-for-PostgreSQL
```
...
# git clone --depth 1 -b polardb-competition-2024 https://gitee.com/digoal/PolarDB-for-PostgreSQL
```
