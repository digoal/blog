## 如何构建PolarDB Docker镜像 OR 本地编译PolarDB?   
...
## 背景  
PolarDB 开源项目`polardb-pg-docker-images`提供了一系列Dockerfile可用于构建CentOS、Rocky、ubuntu、Anolis各版本的Docker镜像. 由于依赖非常多, 参考这些Dockerfile里都安装了一些什么包, 你就可以比较简单的在自己的操作系统环境中直接编译安装PolarDB. 下面文档将参考以下官方文档进行讲解.    
