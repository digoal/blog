...
do  
  ...
  then  
    ...
    nohup pg_receivewal -D /data/polardb_wal_archive -S online_archwal_1 -h 172.17.0.2 -p 5432 -U postgres -d postgres >>/data/polardb_wal_archive/arch.log 2>&1 &     
  fi  
...
state            | streaming  
sent_lsn         | 2/40021960  
write_lsn        | 2/40021928  
flush_lsn        | 2/40000000  
replay_lsn       |   
