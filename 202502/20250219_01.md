...
### 正文提示    
````    
我基于PostgreSQL的代码及其插件, 规划了一门面向DBA、大学生的数据库内核开发课, 讲师是来自企业的开发专家和高校老师, 请给出以下小节的详细正文内容(内容要生动并易于理解, 越详细越好, 尽量提供代码和练习方法, 对于没有把握的内容请标注清楚代码或确认方法, 学生可以自己去找代码或按照你的提示进行二次确认.):      
```    
**第一章：存储引擎与数据组织**    
