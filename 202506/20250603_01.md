...
## 背景      
大家有没有试过 Google Gemini 2.5 Flash 的 Deep Research 功能, 这个功能太强了, 相当于一个智能体的入口, 从一个问题开始展开, 看似和其他AI聊天工具没啥区别, 实则有大大的区别, 参与后续工序的可能涉及推理模型和无数智能体, 甚至与物理世界对接(例如智能制造工厂、电商、智能家电、汽车、手机、银行、金融机构等等).   
