...
该数据库镜像包括PostgreSQL 18及插件(pgvector, pgvectorscale, vectorchord, vectorchord-bm25, pg_tokenizer, pg_search(不支持pg18, 暂未列入), postgresml(不支持pg18, 暂未列入), pg_jieba, pg_bigm , pgroonga, postgis, 以及PG内置插件), DuckDB及插件(duckpgq) ;    
...
curl https://github.com/duckdb/duckdb/releases/download/v1.4.1/duckdb_cli-linux-arm64.gz -o ./duckdb_cli-linux-arm64.gz   
curl https://github.com/duckdb/duckdb/releases/download/v1.4.1/duckdb_cli-linux-amd64.gz -o ./duckdb_cli-linux-amd64.gz  
...
$ ll  
total 634632  
drwxr-x---+ 76 digoal  staff   2.4K Dec  4 16:46 ..  
drwxr-xr-x  17 digoal  staff   544B Dec  4 16:46 pg_jieba  
drwxr-xr-x  19 digoal  staff   608B Dec  4 16:46 pg_bigm  
-rw-r--r--   1 digoal  staff    91M Dec  4 16:47 gcc-14.3.0.tar.xz  
drwxr-xr-x  23 digoal  staff   736B Dec  4 16:47 VectorChord  
drwxr-xr-x  18 digoal  staff   576B Dec  4 16:47 pg_tokenizer.rs  
drwxr-xr-x  17 digoal  staff   544B Dec  4 16:47 VectorChord-bm25  
drwxr-xr-x  19 digoal  staff   608B Dec  4 16:47 pgvectorscale  
-rw-r--r--@  1 digoal  staff    18M Dec  4 16:50 duckdb_cli-linux-amd64.gz  
-rw-r--r--@  1 digoal  staff    17M Dec  4 16:50 duckdb_cli-linux-arm64.gz  
drwxr-xr-x  12 digoal  staff   384B Dec  4 17:11 .  
-rw-r--r--   1 digoal  staff   164M Dec  4 17:11 18.tar.gz  
```  
...
# x86_64 环境gcc 12即可. 可以跳过这个部分, 以及后面编译时的CC配置
...
# build x86 Docker image 仅需修改如下. 还有 1.sh 里面 duckdb 的部分  
