...
-- 比赛的核心部分, 1、创建索引  
-- 请根据这几天的学习, 修改索引参数, 设置查询参数.   
-- 修改索引参数: m=16, ef_construction=64   
-- 设置查询参数: set hnsw.ef_search = 20;
-- 例子  
...
-- 请修改: m=16, ef_construction=64 , 这个修改完成后, 需要删除并使用新的参数创建索引.    
-- 请修改: set hnsw.ef_search = 20;   
...
-- 下面的 ef_search 设置为你的 hnsw.ef_search 最终配置(即满足大于 0.85 时的 hnsw.ef_search)  
