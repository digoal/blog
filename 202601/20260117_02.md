## Gemini CLI Coder Agent 解决外网访问 方法介绍  
...
gemini mcp add playwright "npx @playwright/mcp@latest" --scope user  
  
qwen mcp add deepwiki https://mcp.deepwiki.com/mcp --scope user --transport http  
qwen mcp add playwright "npx @playwright/mcp@latest" --scope user  
```  
