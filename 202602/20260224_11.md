...
PS: 看完[《AI论文解读 | Practical and Asymptotically Optimal Quantization of High-Dimensional Vectors in Euclidean Space for Approximate Nearest Neighbor Search》](../202602/20260224_15.md) , 你会发现 vectorchord 这个版本确实优秀, 一方面支持通过量化类型减少原始值的内存占用, 另一方面在rabitq索引中, 还能通过升位来提高精度.  
