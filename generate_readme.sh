...
echo "13、[《PostgreSQL 核心卖点提取方法》](202006/20200609_02.md)   " >> ./README.md 
echo "14、[《开源数据库全球化协作浪潮 思考 - 24问》](202101/20210120_02.md)       " >> ./README.md
echo "15、[《企业CxO数据库选型应该回答清楚的 15 个问题》](202101/20210117_04.md)         " >> ./README.md
echo "  "  >> ./README.md
