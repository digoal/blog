...
echo "17、[《2025-PolarDB 进阶课程, 穷鬼玩PolarDB RAC一写多读集群 系列文章》](202501/20250114_01.md)     "  >> ./README.md    
...
echo "21、[《2025-AI辅助 学PolarDB/PostgreSQL数据库内核源码 系列课程, 含传统学习曲线及素材建议》](202502/20250218_03.md)     "  >> ./README.md    
echo "  "  >> ./README.md
