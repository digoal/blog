...
2015.7加入阿里巴巴, 阿里云数据库内核组, 数据库架构师, 负责RDS PG, hybrid db for PG的架构设计, 为阿里巴巴内部、专有云、公有云等客户提供架构、方案设计、优化、POC支持. 将用户与行业需求挖掘提炼, 形成行业方案沉淀并进行推广。为产品的前线销售、架构师、后端研发团队提供产品和技术支持。(经历了rds pg, ppas, hdb pg产品的从0到1, 业务从内部推广到外部推广和落地, 数十行业、数百场景的数据库解决方案设计、优化等.)   
...
1、产品功能、架构设计, 指导落地
2、产品周边生态产品推动
3、市场报告, 产品竞争优势、场景、行业案例提炼, 前线赋能
4、售后DBA、开发者、内核团队技能培养
5、DBA培训、认证体系建设
6、业务指标达成: 产品功能, gaap, 客户数, 实例数, 相对友商产品竞争力指标项, 体系建设
7、影响力建设(内部、外部)
8、社区合作
9、开发者生态建设
10、服务类合作伙伴生态建设
