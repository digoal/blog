...
```
简短介绍
简介: zzz, 网名德哥(digoal). 目前就职于阿里云数据库产品与架构部, 阿里云PolarDB数据库开源社区负责人, PostgreSQL 中国社区发起人之一, 40余项数据库专利. 曾承担过DBA、架构师、产品经理、开源社区运营和生态建设等多种角色, 一直致力于推动开源数据库技术、生态在中国的发展与开源产业人才培养. 曾荣获阿里巴巴麒麟布道师称号、2018届OSCAR开源尖峰人物. 
```
