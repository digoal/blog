...
description: Write and save Chinese beginner-friendly paid manual subsections for "全品种操盘手册", a retail-investor education/subscription product covering market regimes, A-shares, ETFs, convertible bonds, gold, Hong Kong/US access, QDII, options, psychology, discipline, position sizing, and risk control. Use when the user provides a subsection title plus references and asks to draft, continue, revise, or save one markdown subsection for 投资小白/散户, especially with triggers like 每次写一小节, 全品种操盘手册, 操盘手册, 知识付费, SVG图解, 第一性原理, markdown目录, or 散户金融工具.
---
...
4. Design SVG diagrams before writing the body.
   ...
   - At minimum include: one concept map or causal chain, one decision tree, and one risk boundary/checklist visual.
...
- Separate facts, interpretation, and educational action framework.
...
- The core claim has explicit premises and re-reasoning if key premises fail.
- The section includes authority-backed evidence or clearly marks evidence gaps.
